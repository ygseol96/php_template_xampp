    ...
    <body>
        ...
        <div class="flex mt-[4.7rem] md:mt-0">
            ...
            <div class="content">
                ...
                <div class="flex flex-wrap items-center justify-between sticky top-0 bg-slate-100 z-50 pt-16 md:pt-0 pb-3 border-b">
                    <div>
                        <div class="flex items-center mt-4">
                            <a href="./golf_reservation_mng.php" class="flex items-center gap-1 text-primary">
                ...
                <!-- 상세 -->
                <!-- 기획서상 3-4 예약상세 1 (골프장) 추후삭제 -->
                <div class="p-3 border rounded-md text-base border-danger text-danger font-medium mb-4">기획서상 3-4 예약상세 1 (골프장)</div>
                            ...
                            <div class="col-span-12 md:col-span-6">
                                <div class="grid grid-cols-12 grid-row-10 gap-2 h-full">
                                    ...
                                    <div class="col-span-12">
                                        <div class="flex items-center justify-center h-full border border-slate-200 rounded-md bg-slate-50">VAT포함</div>
                                    </div>
                                    <!-- 제목 -->
                ...
                <!-- 기획서상 3-4 예약상세2 (골프장) 추후삭제 -->
                <div class="p-3 border rounded-md text-base border-danger text-danger font-medium mb-4">기획서상 3-4 예약상세2 (골프장)</div>
                
                <div class="intro-y">
                    <div class="flex h-[38px]">
                        <h3 class="text-lg font-bold mr-auto text-slate-600 mt-1">참여자 명단(20명)</h3>
                    </div>
                    <div class="box p-5 mt-3 h-[220px] overflow-y-scroll">
                        <div class="grid grid-cols-12 gap-4">
                            <div class="col-span-12 md:col-span-4">
                                <div class="p-3 border border-slate-300 rounded-md shadow-sm text-center">
                                    gildong, hong | 010-1111-2222 | 남
                                </div>
                            </div>
                            <div class="col-span-12 md:col-span-4">
                                <div class="p-3 border border-slate-300 rounded-md shadow-sm text-center">
