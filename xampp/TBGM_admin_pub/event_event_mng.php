        ...
        <div class="flex mt-[4.7rem] md:mt-0">
            ...
            <div class="content">
                ...
                <div class="intro-y flex items-center mt-8">
                    <h2 class="text-xl font-bold mr-auto">행사 목록</h2>
                </div>

                <!-- 필터 -->
                <div class="intro-y box p-5 flex flex-wrap items-end gap-2 mt-3">
                    <div>
                        <div class="mb-1 text-slate-500 font-medium">행사일</div>
                    ...
                    <div>
                        ...
                        <select name="state[]" multiple autocomplete="off" class="tom-select min-w-48">
                            ...
                            <option value="2">행사진행</option>
                            <option value="3">행사종료</option>
                        </select>
                    </div>
                    <div>
                    ...
                    <div>
                        <div class="mb-1 text-slate-500 font-medium">행사제목,담당자</div>
        ...
        <script>
                ...
                var table = new Tabulator("#tabulator", {
                    ...
                    columns:[ //define the table columns
                        ...
                        {title:"예약요청일", field:"date_quote", width:100},
