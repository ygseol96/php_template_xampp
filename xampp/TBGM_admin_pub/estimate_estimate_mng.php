<?php include_once('_head.php'); ?>
    <body>
        ...
        <div class="flex mt-[4.7rem] md:mt-0">
            ...
            <div class="content">
                ...
                <div class="intro-y flex items-center mt-8">
                    <h2 class="text-xl font-bold mr-auto">견적 목록</h2>
                    <a href="./estimate_estimate_regist.php" class="btn btn-primary"><i data-lucide="plus" class="w-4 h-4 mr-1"></i>견적등록</a>
                </div>
        ...
        <script>
                // 데이터
                var tabledata = [
                    {number:241182, title:"경기도 골프장+프로 필드레슨", date_hope:"<div class='flex items-center justify-center'>2024.05.01~<br/>2024.05.03</div>", personnel:"20", region:"대한민국 서울/경기도", department:"000지점 > 0000부서 > 000팀", manager:"홍길동", date_quote:"2024.01.01", state:'<div class="flex items-center justify-center"><img src="./dist/images/progress01.svg" class="!w-[45px] !shadow-none" alt="접수"></div>' },
                    {number:241182, title:"경기도 골프장+프로 필드레슨", date_hope:"<div class='flex items-center justify-center'>2024.05.01~<br/>2024.05.03</div>", personnel:"20", region:"대한민국 서울/경기도", department:"000지점 > 0000부서 > 000팀", manager:"홍길동", date_quote:"2024.01.01", state:'<div class="flex items-center justify-center"><img src="./dist/images/progress02.svg" class="!w-[45px] !shadow-none" alt="견적중"></div>' },
                    {number:241182, title:"경기도 골프장+프로 필드레슨", date_hope:"<div class='flex items-center justify-center'>2024.05.01~<br/>2024.05.03</div>", personnel:"20", region:"대한민국 서울/경기도", department:"000지점 > 0000부서 > 000팀", manager:"홍길동", date_quote:"2024.01.01", state:'<div class="flex items-center justify-center"><img src="./dist/images/progress03.svg" class="!w-[45px] !shadow-none" alt="예약"></div>' },
                    {number:241182, title:"경기도 골프장+프로 필드레슨", date_hope:"<div class='flex items-center justify-center'>2024.05.01~<br/>2024.05.03</div>", personnel:"20", region:"대한민국 서울/경기도", department:"000지점 > 0000부서 > 000팀", manager:"홍길동", date_quote:"2024.01.01", state:'<div class="flex items-center justify-center"><img src="./dist/images/progress04.svg" class="!w-[45px] !shadow-none" alt="미진행"></div>' },
                ]
                ...
                var table = new Tabulator("#tabulator", {
                    ...
                    columns:[ //define the table columns
                        ...
                        {title:"희망지역", field:"region", width:160},
                ...
                table.on("rowClick", function(e, row){
                    location.href='./estimate_estimate_detail.php'
                });
