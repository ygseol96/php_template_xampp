            ...
            <div class="content">
                ...
                <div class="intro-y flex flex-wrap items-center justify-between ">
                    <div>
                        <div class="flex items-center mt-4">
                            <a href="./inquiry_inquiry_mng.php" class="flex items-center gap-1 text-primary">
                                <i data-lucide="move-left" class="w-4 h-4 !stroke-2 text-primary"></i> 문의 목록
                            </a>
                        </div>
                        <div class="flex items-center mt-2">
                            <h2 class="text-xl font-bold mr-auto">문의 상세</h2>
                        </div>
                    </div>
                    <div class="flex items-center gap-2 ml-auto">
                        <button type="button" class="btn btn-primary">명단요청</button>
                        <button type="button" class="btn btn-success">견적요청</button>
                        <button type="button" class="btn btn-warning">문의취소</button>
                    </div>
                </div>
                    ...
                    <div class="col-span-12 xl:col-span-8">
                        <div class="intro-y">
                            <div class="flex h-[38px]">
                                <h3 class="text-lg font-bold mr-auto text-slate-600 mt-1">문의내용</h3>
                            ...
                            <!-- 좌측 box -->
                            <div class="box box p-5 mt-4">
                                <div class="flex items-center">
                                    <h4 class="text-base font-bold text-slate-600 mr-auto">기본사항</h4>
                                ...
                                <div class="mt-4 flex flex-col gap-2 md:gap-4">
                                    <div class="flex flex-wrap flex-col md:flex-row gap-2 md:gap-6">
                                        <div class="flex-1 flex flex-wrap">
                                            <p class="mt-2 w-24 font-medium">업체명</p>
                                            <input type="text" class="form-control flex-1">
                                        </div>
                                        <div class="flex-1 flex flex-wrap">
                                            <p class="mt-2 w-24 font-medium">골프장등급</p>
                                            <select name="" id="" class="form-select flex-1">
                                                <option value="">최상급,상급</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap flex-col md:flex-row gap-2 md:gap-6">
                                        <div class="flex-1 flex flex-wrap">
                                            <p class="mt-2 w-24 font-medium">담당자명</p>
                                            <input type="text" class="form-control flex-1">
                                        </div>
                                        <div class="flex-1 flex flex-wrap">
                                            <p class="mt-2 w-24 font-medium">골프장위치</p>
                                            <select name="" id="" class="form-select flex-1">
                                                <option value="">시내인접, 3시간 이내</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap flex-col md:flex-row gap-2 md:gap-6">
                                        <div class="flex-1 flex flex-wrap">
                                            <p class="mt-2 w-24 font-medium">연락처</p>
                                            <input type="text" class="form-control flex-1">
                                        </div>
                                        <div class="flex-1 flex flex-wrap">
                                    ...
                                    <div class="flex flex-wrap flex-col md:flex-row gap-2 md:gap-6">
                                        <div class="flex-1 flex flex-wrap">
                                            <p class="mt-2 w-24 font-medium">기간</p>
                                            <input type="text" class="form-control flex-1">
                                        </div>
                                        <div class="flex-1 flex flex-wrap">
                                            <p class="mt-2 w-24 font-medium">숙소등급</p>
                                            <select name="" id="" class="form-select flex-1">
                                                <option value="">5성급, 4성급</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap flex-col md:flex-row gap-2 md:gap-6">
                                        <div class="flex-1 flex flex-wrap">
                                            <p class="mt-2 w-24 font-medium">인원수</p>
                                            <input type="text" class="form-control flex-1">
                                        </div>
                                        <div class="flex-1 flex flex-wrap">
                                            <p class="mt-2 w-24 font-medium">숙소종류</p>
                                            <select name="" id="" class="form-select flex-1">
                                                <option value="">다인실, 트윈</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap flex-col md:flex-row gap-2 md:gap-6">
                                        <div class="flex-1 flex flex-wrap">
                                            <p class="mt-2 w-24 font-medium">희망지역</p>
                                            <input type="text" class="form-control flex-1">
                                        </div>
                                        <div class="flex-1 flex flex-wrap">
                                            <p class="mt-2 w-24 font-medium">연회/만찬</p>
                                            <select name="" id="" class="form-select flex-1">
                                                <option value="">연회장, 만찬</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap flex-col md:flex-row gap-2 md:gap-6">
                                        ...
                                        <div class="flex-1 flex flex-wrap gap-2 md:gap-4">
                                            <div class="flex flex-wrap w-full">
                                                ...
                                                <select name="" id="" class="form-select flex-1">
                                                    <option value="">조식,중식,석식</option>
                                                </select>
                                            </div>
                                            <div class="flex flex-wrap w-full">
                                                <p class="mt-2 w-24 font-medium">식사비용</p>
                                                <select name="" id="" class="form-select flex-1">
                                                    <option value="">1인 1식 10~15만원</option>
                                                </select>
                                            </div>
                                            <div class=" flex flex-wrap w-full">
                                                <p class="mt-2 w-24 font-medium">기타</p>
                                                <div class="flex-1 flex flex-wrap">
                                                    <select name="" id="" class="form-select w-full">
                                                        <option value="">빔 스크린, 마이크/엠프, 기타</option>
                                                    </select>
                                                    <textarea class="form-control h-24 w-full mt-2"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="intro-y box p-5 mt-4">
                        ...
                        <div class="flex-1 flex flex-wrap items-center gap-6">
                            <ul class="nav nav-boxed-tabs flex-wrap gap-0.5 border-b-2 border-primary" role="tablist">
                                <li id="bylanguage-1-tab" class="nav-item" role="presentation"> 
                                    <button type="button" class="nav-link py-2 bg-white active" data-tw-toggle="pill" data-tw-target="#bylanguage-tab-1" type="button" role="tab" aria-controls="bylanguage-tab-1" aria-selected="true">한국어</button> 
                                </li>
                                <li id="bylanguage-2-tab" class="nav-item" role="presentation"> 
                                    <button type="button" class="nav-link py-2 bg-white" data-tw-toggle="pill" data-tw-target="#bylanguage-tab-2" type="button" role="tab" aria-controls="bylanguage-tab-2" aria-selected="false">영어</button> 
                                </li>
                                <li id="bylanguage-3-tab" class="nav-item" role="presentation"> 
                                    <button type="button" class="nav-link py-2 bg-white" data-tw-toggle="pill" data-tw-target="#bylanguage-tab-3" type="button" role="tab" aria-controls="bylanguage-tab-3" aria-selected="false" disabled>스페인어</button> 
                                </li>
                                <li id="bylanguage-4-tab" class="nav-item" role="presentation"> 
                                    <button type="button" class="nav-link py-2 bg-white" data-tw-toggle="pill" data-tw-target="#bylanguage-tab-4" type="button" role="tab" aria-controls="bylanguage-tab-4" aria-selected="false">일본어</button> 
                                </li>
                                <li id="bylanguage-5-tab" class="nav-item" role="presentation"> 
                                    <button type="button" class="nav-link py-2 bg-white" data-tw-toggle="pill" data-tw-target="#bylanguage-tab-5" type="button" role="tab" aria-controls="bylanguage-tab-5" aria-selected="false" disabled>중국어</button> 
                                </li>
                            </ul>
                        ...
                        <div class="flex-1">
                            <div class="flex flex-wrap items-center gap-6">
                                ...
                                <div class="form-check"> 
                                    ...
                                    <button type="button" class="btn btn-primary-soft btn-sm ml-3" data-tw-toggle="modal" data-tw-target="#site_select-modal"><i data-lucide="plus" class="w-4 h-4"></i> 사이트 선택</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row gap-3 mb-3">
                        ...
                        <div class="flex-1">
                            <button type="button" class="btn btn-primary-soft btn-sm"><i data-lucide="plus" class="w-4 h-4"></i> 고객사 선택</button>
                        </div>
                    </div>
                ...
                <div class="intro-y flex w-full items-center justify-end gap-2 mt-4">
                    <button type="button" class="btn btn-danger"><i data-lucide="x" class="w-4 h-4 mr-1"></i>팝업삭제</button>
                    <button type="button" class="btn btn-primary"><i data-lucide="plus" class="w-4 h-4 mr-1"></i>팝업등록</button>
                    ...
                    <div class="modal-body p-0">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-[1px] bg-slate-400">
                            <div class="overflow-y-auto h-[140px] md:h-[440px] p-3 bg-white">
                                ...
                                <button type="button" class="block w-full text-left p-2">골프장예약</button>
                                <button type="button" class="block w-full text-left p-2">골프장ERP</button>
                                <button type="button" class="block w-full text-left p-2">검색/포털</button>
                                <button type="button" class="block w-full text-left p-2">OTA/여행사</button>
                                <button type="button" class="block w-full text-left p-2">항공/숙박/차량</button>
                                <button type="button" class="block w-full text-left p-2">금융/은행/카드</button>
                                <button type="button" class="block w-full text-left p-2">쇼핑/마켓</button>
                                <button type="button" class="block w-full text-left p-2">대기업/브랜드</button>
                                <button type="button" class="block w-full text-left p-2">멤버쉽/마일리지</button>
                                <button type="button" class="block w-full text-left p-2">소셜/메신저/기타</button>
                            </div>
                            <div class="md:col-span-2 overflow-y-auto max-h-[auto] md:max-h-[440px] md:h-[440px] p-3 bg-white">
                                <div class="flex flex-wrap items-center gap-1">
                                    <button type="button" class="px-5 py-2 rounded">전체(11)</button>
                                    <!-- 버튼 클릭시 클래스추가 bg-primary bg-opacity-10 font-bold text-primary -->
                                    <button type="button" class="px-5 py-2 rounded bg-primary bg-opacity-10 font-bold text-primary">사이트</button>
                                    <button type="button" class="px-5 py-2 rounded">사이트</button>
                                    <button type="button" class="px-5 py-2 rounded">사이트</button>
                                    <!-- 버튼 클릭시 클래스추가 bg-primary bg-opacity-10 font-bold text-primary -->
                                    <button type="button" class="px-5 py-2 rounded bg-primary bg-opacity-10 font-bold text-primary">사이트</button>
                                    <button type="button" class="px-5 py-2 rounded">사이트</button>
