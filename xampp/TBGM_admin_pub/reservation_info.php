...
<body class="mo_page p-0">
    ...
    <div class="content flex flex-col w-full">
        <div class="flex-1">
            ...
            <div>
                <ul class="nav nav-boxed-tabs border-b border-slate-300" role="tablist">
                    <li id="detail-1-tab" class="nav-item flex-1" role="presentation"> 
                        <button class="nav-link w-full py-2 px-0 !rounded-b-none active" data-tw-toggle="pill" data-tw-target="#detail-tab-1" type="button" role="tab" aria-controls="detail-tab-1" aria-selected="true">상세견적</button> 
                    </li>
                    <li id="detail-2-tab" class="nav-item flex-1" role="presentation"> 
                        <button class="nav-link w-full py-2 px-0 !rounded-b-none" data-tw-toggle="pill" data-tw-target="#detail-tab-2" type="button" role="tab" aria-controls="detail-tab-2" aria-selected="false">상세일정</button> 
                    </li>
                ...
                <div class="tab-content mt-5">
                    <div id="detail-tab-1" class="tab-pane leading-relaxed active" role="tabpanel" aria-labelledby="detail-1-tab">
                        <div class="overflow-x-auto">
                            <table class="table table-sm table-bordered !text-center min-w-[400px]">
                                <colgroup>
                                    <col width="20%">
                                    <col width="30%">
                                    <col width="20%">
                                ...
                                <thead class="bg-primary bg-opacity-90 text-white">
                                    <tr>
                                        <th class="whitespace-nowrap">항목</th>
                                        <th class="whitespace-nowrap">단가</th>
                                        <th class="whitespace-nowrap">단위</th>
                                        <th class="whitespace-nowrap">총액</th>
                                    </tr>
                                </thead>
                        ...
                        <div class="mt-2 text-slate-500">* 부가가치세 10% 포함 금액</div>
                    </div>

                    <div id="detail-tab-2" class="tab-pane leading-relaxed" role="tabpanel" aria-labelledby="detail-2-tab">
        ...
        <div class="sticky bottom-0 w-full bg-white z-10 flex items-center gap-2 py-4">
            ...
            <button type="button" class="btn flex-1 btn-primary" onclick="modalOpen('share-modal')">일정 공유하기</button>
        </div>
