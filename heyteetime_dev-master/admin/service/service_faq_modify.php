...
$data = $ServiceService->getFaqDetail($_GET['idx']);
$data['lang_kind'] = $ServiceService->getServiceLanguageKind($_GET['idx']);
$data['main_idx'] = $_GET['idx'];
...
include_tpl('service/service_faq_modify.tpl', $data);
