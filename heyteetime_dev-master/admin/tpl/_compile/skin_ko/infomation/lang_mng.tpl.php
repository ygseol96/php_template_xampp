<?php /* Template_ 2.2.8 2024/06/09 11:09:47 C:\xampp\heytee_dev\admin\_global\skin_ko\infomation\lang_mng.tpl 000007006 */ ?>
    ...
    <div class="flex flex-col">
        <div class="flex flex-col md:flex-row flex-wrap md:items-center gap-2 md:gap-6">
            ...
            <div class="flex-1 w-full">
                ...
                <input type="text" name="name" value="<?php echo $TPL_V1["name"]?>" class="form-control" placeholder="한국어">
            </div>
            <div class="flex-1 w-full">
