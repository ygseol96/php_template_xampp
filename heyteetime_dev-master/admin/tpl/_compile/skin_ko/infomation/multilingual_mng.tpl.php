<?php /* Template_ 2.2.8 2024/06/12 16:11:40 C:\xampp\heytee_dev\admin\_global\skin_ko\infomation\multilingual_mng.tpl 000021827 */ ?>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu w-32">
                            <ul class="dropdown-content">
                                <li> <a href="javascript:;" class="dropdown-item" onclick="modifyCategory(<?php echo $TPL_V1["idx"]?>);"> <i data-lucide="pencil" class="w-4 h-4 mr-2"></i> 수정 </a> </li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="flex items-center gap-1" onclick="closeModal('multilingual_save-modal')"><i data-lucide="x" class="w-5 h-5"></i></button>
            </div>
            <div class="modal-body">
                <div class="flex items-start gap-2 mb-2">
                    <div class="flex items-center gap-2">
                        <div class="shrink-0 w-20 py-2 font-semibold">코드명</div>
                        <p id="parent_code">PR_DE_TT_</p>
                    </div>
                    <div class="flex-1">
                        <input type="text" name="code_name" class="form-control" placeholder="코드를 입력해주세요.">
                    </div>
                </div>
<?php if(is_array($TPL_R1=$TPL_VAR["data"]['lKind'])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
                <div class="flex items-start gap-2 mb-2">
                    <div class="shrink-0 w-20 py-2 font-semibold"><?php echo $TPL_V1["display_name"]?></div>
                    <div class="flex-1">
                        <input type="text" name="<?php echo $TPL_V1["code"]?>_name" class="form-control required" placeholder="<?php echo $TPL_V1["display_name"]?>(<?php echo $TPL_V1["code"]?>)를 입력해주세요">
                    </div>
                </div>
<?php }}?>
                <div class="flex gap-2 justify-center mt-5">
                    <button type="button" class="px-6 btn btn-outline-danger" onclick="closeModal('multilingual_save-modal')">취소</button>
                    <button type="button" class="px-6 btn btn-primary">저장</button>
                </div>
            </div>
        </div>
