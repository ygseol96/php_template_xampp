<?php /* Template_ 2.2.8 2024/05/16 11:52:53 C:\xampp\heytee_dev\admin\_global\skin_ko\sys\display\exhibition_special_modify.tpl 000025318 */ ?>
...
<div class="intro-y flex flex-wrap items-center justify-between ">
    <div>
        ...
        <div class="flex items-center mt-2">
            <h2 class="text-xl font-bold mr-auto">기획전 수정</h2>
        </div>
    </div>
    <div class="flex items-center gap-2 ml-auto">
        <button class="btn btn-primary"><i data-lucide="plus" class="w-4 h-4 mr-1"></i>기획전저장</button>
