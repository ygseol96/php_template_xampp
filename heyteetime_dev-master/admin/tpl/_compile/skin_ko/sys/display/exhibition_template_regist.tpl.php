<?php /* Template_ 2.2.8 2024/05/16 09:44:58 C:\xampp\heytee_dev\admin\_global\skin_ko\sys\display\exhibition_template_regist.tpl 000080760 */ ?>
...
<div class="intro-y flex flex-wrap items-center justify-between ">
    <div>
        ...
        <div class="flex items-center mt-2">
            <h2 class="text-xl font-bold mr-auto">템플릿 등록</h2>
        </div>
    </div>
    <div class="flex items-center gap-2 ml-auto">
        <button class="btn btn-primary"><i data-lucide="plus" class="w-4 h-4 mr-1"></i>템플릿등록</button>
                            ...
                            <div class="w-full">
                                ...
                                <div class="overflow-y-auto max-h-52 p-4 mt-3 flex flex-wrap items-center gap-2 bg-slate-100 rounded">
                                    <div class="overflow-hidden relative flex items-center gap-2 border-4 bg-white rounded-lg cursor-pointer">
                                        ...
                                        <img class="w-40" src="/_global/dist/images/sample_img.jpg" alt="">
                                        <!-- 이미지로만 사용시 아래 div 제거 -->
                                    ...
                                    <div class="overflow-hidden relative border-4 bg-white rounded-lg cursor-pointer w-full md:max-w-[300px]">
                                        ...
                                        <div class="flex items-center pt-3 pl-3 pr-3">
                                            <div class="flex items-center gap-2">
                                                <img class="w-10 h-10 rounded-md" src="/_global/dist/images/sample_img.jpg" alt="">
                                        ...
                                        <div class="flex items-center gap-2 p-3">
                                            ...
                                            <img class="w-1/3 rounded-md" src="/_global/dist/images/sample_img.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
...
<div class="intro-y flex w-full items-center justify-end gap-2 mt-4">
    <button class="btn btn-primary"><i data-lucide="plus" class="w-4 h-4 mr-1"></i> 템플릿등록</button>
    <button class="btn btn-danger"><i data-lucide="x" class="w-4 h-4 mr-1"></i> 템플릿취소</button>
</div>
<!-- 콘텐츠 추가하기 모달 -->
