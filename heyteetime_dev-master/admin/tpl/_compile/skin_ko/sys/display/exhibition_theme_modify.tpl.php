<?php /* Template_ 2.2.8 2024/05/16 11:54:48 C:\xampp\heytee_dev\admin\_global\skin_ko\sys\display\exhibition_theme_modify.tpl 000018131 */ ?>
...
<div class="intro-y flex flex-wrap items-center justify-between ">
    <div>
        ...
        <div class="flex items-center mt-2">
            <h2 class="text-xl font-bold mr-auto">테마 수정</h2>
        </div>
    </div>
