<?php /* Template_ 2.2.8 2024/02/16 08:59:10 /home/agl/www/admin/_global/skin_ko/sys/code_airport_write.tpl 000007013 */ ?>
...
<?php if($TPL_VAR["editmode"]=="code_airport_insert"){?>
	...
	<form name="iform" id="iform">
		...
		<div id="SYRightArea" >
			<div id="SYContentTitle">
				<ul>
				   <li id="SYMenuTitle" class="Title"> 공항코드 상세 <?php if($TPL_VAR["editmode"]=="code_airport_update"){?> - <?php echo $TPL_VAR["data"]["airport_nm_kr"]?><?php }?></li>
...
<?php if($TPL_VAR["editmode"]=="code_airport_insert"){?>
							<select name='nat_cd' id='nat_cd' class="SYSelectBox01" onchange="get_citycode(this.value)">
								...
								<?php echo selectOption($TPL_VAR["nat"],$TPL_VAR["data"]["nat_cd"],'db')?>
...
<?php if($TPL_VAR["editmode"]=="code_airport_insert"){?>
							<select name='city_code' id='city_code' class="SYSelectBox01" >
								<option value="">선택</option>
								<?php echo selectOption($TPL_VAR["nat"],$TPL_VAR["data"]["city_code"],'db')?>
...
<?php if($TPL_VAR["editmode"]=="code_airport_insert"){?>
							<input type="text" name="airport_code" id="airport_code" class="SYInputStyle02 upper"  value="<?php echo $TPL_VAR["data"]["airport_code"]?>"  autocomplete="off" maxlength=3 style="width:40px">
							<p class="Tip01">공항코드는 영문3자리 </p>
<?php }else{?>
							<?php echo $TPL_VAR["data"]["airport_code"]?>
...
<?php }?>
				...
				<tr>
					...
					<td class="Content" >
						<input type="text" name="airport_nm_kr" id="airport_nm_kr" class="SYInputStyle02"  value="<?php echo $TPL_VAR["data"]["airport_nm_kr"]?>"  autocomplete="off" style="width:200px">		
					</td>
					<td class="Title" >공항명 영문 </td> 
					<td class="Content"  >
						<input type="text" name="airport_nm_en" id="airport_nm_en" class="SYInputStyle02"  value="<?php echo $TPL_VAR["data"]["airport_nm_en"]?>"  autocomplete="off" style="width:200px">
				...
				<tr>
					...
					<td class="Content" >
						<input type="text" name="airport_nm_jp" id="airport_nm_jp" class="SYInputStyle02"  value="<?php echo $TPL_VAR["data"]["airport_nm_jp"]?>"  autocomplete="off" style="width:200px">		
					</td>
					<td class="Title" >공항명 중국어 </td> 
					<td class="Content"  >
						<input type="text" name="airport_nm_cn" id="airport_nm_cn" class="SYInputStyle02"  value="<?php echo $TPL_VAR["data"]["airport_nm_cn"]?>"  autocomplete="off" style="width:200px">
				...
				<tr>
					...
					<td class="Content" colspan=3 >
						<input type="text" name="airport_nm_keyword" id="airport_nm_keyword" class="SYInputStyle02"  style="width:400px" value="<?php echo $TPL_VAR["data"]["airport_nm_keyword"]?>"  autocomplete="off">
