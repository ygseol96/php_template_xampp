<?php /* Template_ 2.2.8 2024/04/22 11:22:59 C:\xampp\heytee_dev\admin\_global\skin_ko\sys\member\member_coupon_payment.tpl 000013559 */ ?>
        ...
        <div class="flex-1">
            <div class="flex flex-wrap items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <button class="btn btn-primary-soft"><i data-lucide="plus" class="w-4 h-4 mr-1"></i> 발송지추가</button>
                </div>
                <div>
