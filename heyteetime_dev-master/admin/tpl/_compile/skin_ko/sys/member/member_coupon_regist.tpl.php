<?php /* Template_ 2.2.8 2024/04/22 13:55:46 C:\xampp\heytee_dev\admin\_global\skin_ko\sys\member\member_coupon_regist.tpl 000042677 */ ?>
...
<div class="intro-y box p-5 mt-4">
    ...
    <div class="flex flex-col md:flex-row gap-3 mb-3">
        ...
        <div class="flex-1">
            ...
            <div class="overflow-y-auto max-h-96 p-4 mt-3 bg-slate-100 rounded">
                ...
                <div class="flex flex-col md:flex-row gap-3 mb-2">
                    ...
                    <div class="flex-1 flex flex-wrap items-center gap-2">
                        <div class="overflow-hidden relative flex items-center gap-2 border border-slate-300 bg-white rounded-lg">
                            <img class="w-40" src="/_global/skin_ko/sys/member/dist/images/sample_img.jpg" alt="">
    ...
    <div class="flex flex-col md:flex-row gap-3 mb-3">
        ...
        <div class="flex-1 flex flex-wrap items-center gap-6">
            <div class="form-check">
                <input id="coupon_5_1" class="form-check-input" type="radio" name="coupon_5">
                <label class="form-check-label" for="coupon_5_1">쿠폰지급</label>
            </div>
            <div class="form-check flex-wrap">
                <input id="coupon_5_2" class="form-check-input" type="radio" name="coupon_5">
                <label class="form-check-label" for="coupon_5_2">쿠폰번호배포</label>
                <!-- 쿠폰번호배포 선택시 표기 -->
                <div class="flex items-center gap-1 ml-4">
                    <input type="text" class="form-control form-control-sm w-full md:w-40">
                    <button class="btn btn-sm btn-primary-soft">중복체크</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2">
        <div class="flex flex-col md:flex-row gap-3 mb-3">
            ...
            <div class="flex-1 flex items-center gap-2">
                <input type="text" class="form-control w-40" value="100,000">
                <div class="form-check">
                    <input id="coupon_6_1" class="form-check-input" type="checkbox" name="coupon_6">
