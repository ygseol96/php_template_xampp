<?php /* Template_ 2.2.8 2024/02/16 08:59:10 /home/agl/www/admin/_global/skin_ko/sys/code_phone_write.tpl 000004517 */ ?>
<?php $this->print_("head",$TPL_SCP,1);?>
	...
	<script type="text/javascript">
		...
		function code_phone_save() {

<?php if($TPL_VAR["editmode"]=="code_phone_insert"){?>
	...
	<form name="iform" id="iform">
		...
		<div id="SYRightArea" >
			<div id="SYContentTitle">
				<ul>
				   <li id="SYMenuTitle" class="Title"> 국가번호코드 상세 <?php if($TPL_VAR["editmode"]=="code_phone_update"){?> - <?php echo $TPL_VAR["data"]["nat_cd"]?><?php }?></li>
				   <li id="SYMenuNavi" class="Navi">시스템관리 > 통합코드 > 국가번호코드 > 상세</li>
				</ul>
			</div>
...
<?php }else{?>
							<?php echo $TPL_VAR["data"]["nat_name"]?> (<?php echo $TPL_VAR["data"]["nat_cd"]?>)
<?php }?>
						
					</td>
					<td class="Title" >국가번호 *</td> 
					<td class="Content"  >
						<input type="text" name="phone_code" id="phone_code" class="SYInputStyle02 upper"  value="<?php echo $TPL_VAR["data"]["phone_code"]?>"  autocomplete="off" maxlength=10 style="width:100px">
						<p class="Tip01"></p>
		...
		<div class="btnlistarea" style="margin-top:20px; ">
			<div class="btnlistleft" >
				&nbsp;
				<input type="button" class="SYButtonSubmit04" value="저장하기" onclick="code_phone_save()">
