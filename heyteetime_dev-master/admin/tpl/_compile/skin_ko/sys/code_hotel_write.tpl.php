<?php /* Template_ 2.2.8 2024/02/22 15:36:02 /home/agl/www/admin/_global/skin_ko/sys/code_hotel_write.tpl 000016954 */ ?>
	...
	<form name="iform" id="iform">
		...
		<div id="SYRightArea" >
			<div id="SYContentTitle">
				<ul>
				   <li id="SYMenuTitle" class="Title"> 호텔코드 상세 <?php if($TPL_VAR["editmode"]=="code_hotel_update"){?> - <?php echo $TPL_VAR["data"]["hotel_nm"]?><?php }?></li>
			...
			<table class="SYWirteTable" style="margin-top:10px">
				...
				<tr>
					...
					<td class="Content"  >
<?php if($TPL_VAR["editmode"]=="code_hotel_insert"){?>
						<p class="Tip" >자동생성</p>
<?php }else{?>
						<?php echo $TPL_VAR["data"]["hotel_code"]?>
...
<?php }?>
				...
				<tr>
					...
					<td class="Content"  >
						<select name="grade" id="grade" class="SYSelectBox01">
							...
							<option value="3" <?php if($TPL_VAR["data"]["grade"]=='3'){?>selected<?php }?>>3성</option>
							<option value="4" <?php if($TPL_VAR["data"]["grade"]=='4'){?>selected<?php }?>>4성</option>
							<option value="5" <?php if($TPL_VAR["data"]["grade"]=='5'){?>selected<?php }?>>5성</option>
							<option value="7" <?php if($TPL_VAR["data"]["grade"]=='7'){?>selected<?php }?>>7성</option>
						</select>
				...
				<tr>
					...
					<td class="Content" colspan=3  >
						<input type="text" name="website" id="website" class="SYInputStyle02"  value="<?php echo dbUnEscape($TPL_VAR["data"]["website"])?>"  autocomplete="off" style="width:87%;height:20px;" placeholder="https://"><input type="button" class="SYButtonType03" value="보기" onclick="goout_url('website')" >
				...
				<tr>
					...
					<td class="Content"  >
						<div style="display:inline-block;position:relative; width:90px">
							<label class="switch">
							  <input type="checkbox" name="use_yn" id="use_yn" value="Y" <?php if($TPL_VAR["data"]["use_yn"]!='N'){?> checked<?php }?>>  
						...
						<div style="display:inline-block;position:relative;width:90px ">
							<label class="switch">
							  <input type="checkbox" name="view_yn" id="view_yn" value="Y" <?php if($TPL_VAR["data"]["view_yn"]!='N'){?> checked<?php }?>>  
							  <span class="slider round"></span>
							  <span class="text"> 
								노출
							  </span>
			...
			<table class="SYWirteTable" style="margin-top:10px">
				...
				<tr>
					...
					<td class="Content"  >
						<input type="text" name="hotel_nm" id="hotel_nm" class="SYInputStyle02"  value="<?php echo dbUnEscape($TPL_VAR["data"]["hotel_nm"])?>"  autocomplete="off" style="width:80%" >
					</td>
				...
				<tr>
					...
					<td class="Content"  >
						<input type="text" name="hotel_nm_en" id="hotel_nm_en" class="SYInputStyle02"  value="<?php echo dbUnEscape($TPL_VAR["data"]["hotel_nm_en"])?>"  autocomplete="off" style="width:80%" >
					</td>
				...
				<tr>
					...
					<td class="Content"  >
						<input type="text" name="hotel_nm_jp" id="hotel_nm_jp" class="SYInputStyle02"  value="<?php echo dbUnEscape($TPL_VAR["data"]["hotel_nm_jp"])?>"  autocomplete="off" style="width:80%" >
					</td>
			...
			<table class="SYWirteTable" style="margin-top:10px">
				...
				<tr>
					...
					<td class="Title" >한글 </td> 
					<td class="Content"  >
						<textarea name="intro" id="intro" class="MWTextareaStyle01"  ><?php echo dbUnEscape($TPL_VAR["data"]["intro"])?></textarea>
					</td>
				...
				<tr>
					<td class="Title" >영어 </td> 
					<td class="Content"  >
						<textarea name="intro_en" id="intro_en" class="MWTextareaStyle01"  ><?php echo dbUnEscape($TPL_VAR["data"]["intro_en"])?></textarea>
					</td>
				...
				<tr>
					<td class="Title" >일본어 </td> 
					<td class="Content"  >
						<textarea name="intro_jp" id="intro_jp" class="MWTextareaStyle01"  ><?php echo dbUnEscape($TPL_VAR["data"]["intro_jp"])?></textarea>
					</td>
			...
			<table class="SYWirteTable" style="margin-top:10px">
				...
				<tr>
					...
					<td class="Title" >한글 </td> 
					<td class="Content"  >
						<textarea name="traffic" id="traffic" class="MWTextareaStyle01"  ><?php echo dbUnEscape($TPL_VAR["data"]["traffic"])?></textarea>
					</td>
				...
				<tr>
					<td class="Title" >영어 </td> 
					<td class="Content"  >
						<textarea name="traffic_en" id="traffic_en" class="MWTextareaStyle01"  ><?php echo dbUnEscape($TPL_VAR["data"]["traffic_en"])?></textarea>
					</td>
				...
				<tr>
					<td class="Title" >일본어 </td> 
					<td class="Content"  >
						<textarea name="traffic_jp" id="traffic_jp" class="MWTextareaStyle01"  ><?php echo dbUnEscape($TPL_VAR["data"]["traffic_jp"])?></textarea>
					</td>
			...
			<table class="SYWirteTable" style="margin-top:10px">
				...
				<tr>
					...
					<td class="Title" >한글 </td> 
					<td class="Content"  >
						<textarea name="info" id="info" class="MWTextareaStyle01"  ><?php echo dbUnEscape($TPL_VAR["data"]["info"])?></textarea>
					</td>
				...
				<tr>
					<td class="Title" >영어 </td> 
					<td class="Content"  >
						<textarea name="info_en" id="info_en" class="MWTextareaStyle01"  ><?php echo dbUnEscape($TPL_VAR["data"]["info_en"])?></textarea>
					</td>
				...
				<tr>
					<td class="Title" >일본어 </td> 
					<td class="Content"  >
						<textarea name="info_jp" id="info_jp" class="MWTextareaStyle01"  ><?php echo dbUnEscape($TPL_VAR["data"]["info_jp"])?></textarea>
					</td>
