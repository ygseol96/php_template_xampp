<?php /* Template_ 2.2.8 2024/05/16 11:21:42 C:\xampp\heytee_dev\admin\_global\skin_ko\sys\reservation\reservation_detail.tpl 000022171 */ ?>
...
<div class="intro-y flex flex-wrap items-center justify-between">
    ...
    <div class="flex items-center gap-2 ml-auto">
        <button class="btn btn-primary"><i data-lucide="plus" class="w-4 h-4 mr-1"></i> 예약확정</button>
        <button class="btn btn-danger"><i data-lucide="x" class="w-4 h-4 mr-1"></i> 예약취소</button>
    </div>
</div>
        ...
        <div class="md:flex gap-2">
            <div class="flex-1 mt-1 p-3 border border-slate-300 rounded-lg overflow-hidden whitespace-nowrap">
                ...
                <div class="flex flex-wrap whitespace-normal px-5">
                    <div class="relative text-base w-24 shrink-0">
            ...
            <button class="btn btn-success w-full md:w-12 mt-2 md:mt-0 p-3" data-tw-toggle="modal" data-tw-target="#reser_cancel-modal">예약취소</button>
        </div>

        <h4 class="mt-4">예약번호 : VNDNVP-4DAG28O</h4>
        <div class="md:flex gap-2">
            <div class="flex-1 mt-1 p-3 border border-slate-300 rounded-lg overflow-hidden whitespace-nowrap">
                <div class="flex flex-wrap items-center">
                    <div class="flex-1 px-5 py-2">
                ...
                <div class="flex flex-wrap px-5 pt-2">
                    <div class="relative text-base w-24 shrink-0 text-danger line-through">
                        <button type="button" class="absolute -left-6 top-1 btn btn-sm btn-danger rounded-full p-0.5" data-tw-toggle="modal" data-tw-target="#reser_cancel-modal">
                            <i data-lucide="x" class="w-3 h-3"></i>
                        </button>
                        클럽렌탈
                    </div>
                    <div class="text-base w-24 shrink-0 text-danger line-through">200,000</div>
                    <div class="text-base text-danger line-through">남성 2, 여성 2</div>
                </div>
            </div>
    ...
    <div class="intro-y box overflow-x-auto p-5 mt-2 overflow-hidden whitespace-nowrap">
        <table class="table">
            ...
            <tr>
                ...
                <td class="!px-1"><button class="btn btn-danger">수정하기</button></td>
            </tr>
            <tr>
                <td class="!px-1"><input type="text" class="form-control" value="1"></td>
                <td class="!px-1"><input type="text" class="form-control" value="first name"></td>
                <td class="!px-1"><input type="text" class="form-control" value="last name"></td>
                <td class="!px-1">
                ...
                <td class="!px-1"><button class="btn btn-primary">저장하기</button></td>
            </tr>
            <tr>
                <td class="!px-1"><input type="text" class="form-control" disabled value="1"></td>
                <td class="!px-1"><input type="text" class="form-control" disabled value="first name"></td>
