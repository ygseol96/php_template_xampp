<?php /* Template_ 2.2.8 2024/02/26 18:05:52 /home/agl/www/admin/_global/skin_ko/sys/code_state.tpl 000006548 */ 
	   ...
	   <div id="SYContentTitle">
	    ...
	    <div class="SYSearchBox01" >
			<div class="TitleBar" >
				<ul>
					<li class="Left">
						<span class="Title">검색 전체</span> : <span id="intTotalCountID" class="Number"><?php echo number_format($TPL_VAR["TotalCnt"], 0)?></span>건
...
<?php if($TPL_data_1){$TPL_I1=-1;foreach($TPL_VAR["data"] as $TPL_V1){$TPL_I1++;?>
				<tr >						
					...
					<td  class="ce"><?php echo $TPL_V1["state_cd"]?></td>
					<td  class="ce"><?php echo $TPL_V1["state_nm_kr"]?></td>
					<td  class="ce"><?php echo $TPL_V1["state_nm_en"]?></td>
					<td  class="ce"><?php echo $TPL_V1["state_nm_jp"]?></td>
					<td  class="ce"><?php echo $TPL_V1["state_gubun_txt"]?></td>
					...
					<td  class="ce">
						<input type="button" class="SYButtonType03" value="수정" onclick="code_state_write('<?php echo $TPL_V1["state_seq"]?>')" >
						
					</td>
					<td  class="ce">
						<input type="button" class="SYButtonDelete01" onclick="code_state_del('<?php echo $TPL_V1["state_seq"]?>')" >
					</td>
					<td > </td>
				</tr>
<?php }}?>
