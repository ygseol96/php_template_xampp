<?php /* Template_ 2.2.8 2024/02/16 08:59:10 /home/agl/www/admin/_global/skin_ko/sys/code_city_list.tpl 000007115 */ 
...
<?php if($TPL_data_1){$TPL_I1=-1;foreach($TPL_VAR["data"] as $TPL_V1){$TPL_I1++;?>
				<tr >						
					...
					<td  class="ce"><?php echo $TPL_V1["city_nm_kr"]?></td>

					<td  class="ce"><?php echo $TPL_V1["city_nm_en"]?></td>
					<td  class="ce"><?php echo $TPL_V1["city_nm_jp"]?></td>
					<td  class="ce"><?php echo $TPL_V1["city_nm_cn"]?></td>
					<td  class="ce"><?php echo $TPL_V1["nat_cd"]?></td>
					<td  class="ce"><?php echo $TPL_V1["nat_name"]?></td>
					<td  class="ce"><?php echo dbUnEscape($TPL_V1["city_nm_keyword"])?></td>
					<td  class="ce"><?php echo $TPL_V1["view_yn_txt"]?></td>
					<td  class="ce">
						<input type="button" class="SYButtonType03" value="수정" onclick="code_city_write('<?php echo $TPL_V1["city_seq"]?>')" >
						
					</td>
					<td  class="ce">
						<input type="button" class="SYButtonDelete01" onclick="code_city_del('<?php echo $TPL_V1["city_seq"]?>')" >
					</td>
					<td > </td>
				</tr>
<?php }}?>
