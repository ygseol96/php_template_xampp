<?php /* Template_ 2.2.8 2024/02/16 08:59:10 /home/agl/www/admin/_global/skin_ko/sys/log_history.tpl 000007005 */ 
			...
			<div style="position:relative;padding:10px; border:1px solid #ddd;"  >
				<ul >
					<li >	
						...
						날짜
						<input type="text" name="s_sdate" id="s_sdate" class="SYInputStyle01 datepicker" style="width:80px;" value="<?php echo $_REQUEST["s_sdate"]?>" id="s_sdate" placeholder="시작일시" autocomplete="off">
						<span class="bar">~</span>
						<input type="text" name="s_edate" id="s_edate" class="SYInputStyle01 datepicker" style="width:80px;" value="<?php echo $_REQUEST["s_edate"]?>"  id="s_edate" placeholder="종료일시" autocomplete="off">
						...
						<div class="ui-widget" >
							...
							<select name='s_adm' id='s_adm' class="select-combobox" >
								...
								<?php echo selectOption($TPL_VAR["admin_member"],$_REQUEST["s_adm"],'db')?>
...
<?php if($TPL_data_1){$TPL_I1=-1;foreach($TPL_VAR["data"] as $TPL_V1){$TPL_I1++;?>
				<tr >						
					...
					<td  class="ce"><?php echo $TPL_V1["nav"]?></td>
					<td  class="le"><?php echo $TPL_V1["memo"]?></td>
