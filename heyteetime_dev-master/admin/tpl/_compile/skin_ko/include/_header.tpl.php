<?php /* Template_ 2.2.8 2024/06/19 15:21:22 C:\xampp\heyteetime_dev\admin\_global\skin_ko\include\_header.tpl 000007299 */ ?>
<!-- BEGIN: Top Bar -->
<div class="top-bar">
    <!-- BEGIN: Breadcrumb -->
    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#"><?php echo $TPL_VAR["data"]['nav'][ 0]?></a></li>
            <li class="breadcrumb-item <?=$depth_3 ?'':'active' ?>" aria-current="page"><?php echo $TPL_VAR["data"]['nav'][ 1]?></li>
            <li class="breadcrumb-item <?=$depth_3 ?'active':'hidden' ?>" aria-current="page"><?php echo $TPL_VAR["data"]['nave'][ 2]?></li>
        </ol>
    </nav>
    <!-- END: Breadcrumb -->
        ...
        <div class="notification-content pt-2 dropdown-menu">
            <div class="notification-content__box dropdown-content">
                ...
                <div class="flex items-center justify-between mb-3">
                    <button class="btn btn-primary-soft btn-sm">모두읽음</button>
    ...
    <div class="intro-x dropdown w-8 h-8">
        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-tw-toggle="dropdown">
            <img alt="Midone - HTML Admin Template" src="/_global/<?php echo $_SESSION['adm_skin']?>/dist/images/sample_img.jpg">
        </div>
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content bg-primary text-white">
                ...
                <li>
                    <a href="javascript:;" class="dropdown-item hover:bg-white/5"  data-tw-toggle="modal" data-tw-target="#my_info-modal"> <i data-lucide="user" class="w-4 h-4 mr-2" ></i>내정보 수정</a>
                </li>
                <!-- <li>
