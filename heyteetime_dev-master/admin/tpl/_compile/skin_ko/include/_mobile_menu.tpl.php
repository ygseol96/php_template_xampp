<?php /* Template_ 2.2.8 2024/06/20 10:29:36 C:\Users\코드아이디어\projects\heyteetime_dev\admin\_global\skin_ko\include\_mobile_menu.tpl 000012575 */ ?>
<?php echo $TPL_VAR["data"][ 0]?>

<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar justify-between">
        <a href="" class="flex">
            <img alt="logo" class="h-12" src="/_global/<?php echo $_SESSION['adm_skin']?>/dist/images/heyteetime/logo_white.svg">
        </a>
