<?php /* Template_ 2.2.8 2024/06/19 15:21:22 C:\xampp\heyteetime_dev\admin\_global\skin_ko\include\bottom.tpl 000040635 */ ?>
</div>
</div>

<!-- JS Assets-->
<script src="/_global/<?php echo $_SESSION['adm_skin']?>/dist/js/app.js?v=<?=time()?>"></script>

<script type="text/javascript" src="https://cdn.jsdelivr.net/jquery/latest/jquery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.16.9/xlsx.full.min.js"></script>

    <!-- 테이블 js : tabulator -->
<script src="/_global/<?php echo $_SESSION['adm_skin']?>/dist/js/tabulator.min.js?v=<?=time()?>"></script>
<!-- 차트 js 추가 -->
<script src="/_global/<?php echo $_SESSION['adm_skin']?>/dist/js/chart.js?v=<?=time()?>"></script>
<script src="/_global/<?php echo $_SESSION['adm_skin']?>/dist/js/datalabels.js?v=<?=time()?>"></script>
<script src="/_global/<?php echo $_SESSION['adm_skin']?>/dist/js/swiper-bundle.min.js?v=<?=time()?>"></script>

<script src="/_global/<?php echo $_SESSION['adm_skin']?>/js/jquery-2.2.4.min.js?v=<?=time()?>"></script>


<!-- custom js 파일 호출 //-->
<script src="/_global/<?php echo $_SESSION['adm_skin']?>/dist/js/custom.js?v=<?=time()?>"></script>
...
<?php if(!empty($TPL_VAR["data"]['js'])){?>
<?php if(is_array($TPL_R1=$TPL_VAR["data"]['js'])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
<script src="/_global/<?php echo $_SESSION['adm_skin']?>/js/custom/<?php echo $TPL_V1["name"]?>?v=<?=time()?>"></script>
<?php }}?>
<?php }?>
                    ...
                    <div id="exhibit_prod-tab-2" class="tab-pane leading-relaxed pt-3" role="tabpanel" aria-labelledby="exhibit_prod-2-tab">
                        <div class="flex flex-col gap-2">
                            ...
                            <button class="overflow-hidden relative rounded-xl border-4 border-primary">
                                <img src="/_global/<?php echo $_SESSION['adm_skin']?>/dist/images/banner_sample.png" alt="">
                    ...
                    <div id="exhibit_prod-tab-4" class="tab-pane leading-relaxed" role="tabpanel" aria-labelledby="exhibit_prod-4-tab">
                        ...
                        <div class="z-10 relative flex flex-wrap items-center gap-2">
                            ...
                            <div class="overflow-hidden relative flex items-center gap-2 border-4 border-primary bg-white rounded-lg cursor-pointer">
                                <img class="w-40" src="/_global/<?php echo $_SESSION['adm_skin']?>/dist/images/sample_img.jpg" alt="">
                                <!-- 이미지로만 사용시 아래 div 제거 -->
