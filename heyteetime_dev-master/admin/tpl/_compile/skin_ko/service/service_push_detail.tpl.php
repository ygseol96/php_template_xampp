<?php /* Template_ 2.2.8 2024/06/05 15:12:03 C:\xampp\heytee_dev\admin\_global\skin_ko\service\service_push_detail.tpl 000017276 */ ?>
...
<div class="intro-y flex flex-wrap items-center justify-between gap-2">
    <div>
        ...
        <div class="flex items-center mt-2">
            <h2 class="text-xl font-bold mr-auto">푸시 상세</h2>
        </div>
    </div>
</div>
...
<div class="intro-y box p-5 mt-3">
    <div class="flex items-center justify-between mb-2">
        <h3 class="text-lg font-bold mr-auto">푸시정보</h3>
        <div class="flex flex-wrap items-center gap-2 ml-auto">
            <button class="btn bg-purple-800 text-white">푸시 재발송</button>
            <button class="btn btn-success text-black">발송일시정지</button>
        </div>
    </div>
    <div class="flex flex-col gap-2 p-2 border border-slate-200 rounded">
        <div class="flex flex-wrap items-start gap-2 whitespace-nowrap">
            ...
            <div class="flex-1 py-1.5 px-3">
                <div class="mb-0.5 text-slate-500">푸시구분</div>
                <div>기획전</div>
            </div>
            <div class="flex-1 py-1.5 px-3">
                <div class="mb-0.5 text-slate-500">푸시명</div>
                <div>일본 아코디아 기획전</div>
            </div>
            <div class="flex-1 py-1.5 px-3">
        ...
        <div class="flex items-center gap-2">
            ...
            <div class=" py-1.5 px-3">
                <div class="mb-0.5 text-slate-500">링크</div>
                <div>http://www.heyteetime/search?field=aja010&lang=en&prcd=01010</div>
            </div>
        </div>
        <div>
            <div class="flex-1 py-1.5 px-3">
                <div class="mb-0.5 text-slate-500">내용</div>
                <div class="break-all">일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전 일본 아코디아 기획전</div>
            </div>
        </div>
    </div>
...
<div class="intro-y box p-5 flex flex-wrap items-end gap-2 mt-5">
    ...
    <div>
        <div class="mb-1 text-slate-500 font-medium">발송 OS</div>
        <div class="dropdown">
            <button class="dropdown-toggle form-select w-28 text-left" aria-expanded="false" data-tw-toggle="dropdown">미선택</button>
            <div class="dropdown-menu w-full">
                <ul class="dropdown-content custom_select multi">
                    <li class="flex items-center">
                        <input type="radio" class="form-check-input" id="shipping_os_1_1" name="shipping_os">
                        <label for="shipping_os_1_1" class="block w-full px-2 py-1">전체</label>
                    </li>
                    <li class="flex items-center mt-0.5">
                        <input type="radio" class="form-check-input" id="shipping_os_1_2" name="shipping_os">
                        <label for="shipping_os_1_2" class="block w-full px-2 py-1">AOS </label>
                    </li>
                    <li class="flex items-center mt-0.5">
                        <input type="radio" class="form-check-input" id="shipping_os_1_3" name="shipping_os">
                        <label for="shipping_os_1_3" class="block w-full px-2 py-1">IOS</label>
                    </li>
                </ul>
            </div>
        </div>
...
<script>
    // 데이터
    var tabledata = [
        {number:1, id:"testid@test.com", name:"홍길동", nationality:"대한민국", gender:"남", OS:"AOS", reception_status:"발송완료", confirmation_date:"-", },
        {number:2, id:"testid@test.com", name:"홍길동", nationality:"일본", gender:"여", OS:"IOS", reception_status:"발송실패", confirmation_date:"-", },
        {number:3, id:"testid@test.com", name:"홍길동", nationality:"프랑스", gender:"남", OS:"IOS", reception_status:"확인완료", confirmation_date:"-", },
    ]
    ...
    var table = new Tabulator("#tabulator", {
        ...
        columns:[ //define the table columns
            ...
            {title:"OS", field:"OS", minWidth:100},
