<?php /* Template_ 2.2.8 2024/06/05 15:17:13 C:\xampp\heytee_dev\admin\_global\skin_ko\service\service_mail_regist.tpl 000034459 */ ?>
...
<div class="intro-y flex flex-wrap items-center justify-between ">
    <div>
        ...
        <div class="flex items-center mt-2">
            <h2 class="text-xl font-bold mr-auto">메일 등록</h2>
        </div>
    </div>
    <div class="flex items-center gap-2 ml-auto">
        <button class="btn btn-primary"><i data-lucide="plus" class="w-4 h-4 mr-1"></i>메일등록</button>
...
<div class="intro-y box p-5 mt-4">
    <div class="flex flex-col md:flex-row gap-3 mb-3">
        <div class="w-full md:w-40 pt-2 font-semibold">메일명</div>
        <div class="flex-1">
                ...
                <div id="bylanguage-tab-1" class="tab-pane leading-relaxed active" role="tabpanel" aria-labelledby="bylanguage-1-tab">
                    ...
                    <div class="flex flex-col md:flex-row gap-3 mb-3">
                        ...
                        <div class="flex-1 flex flex-wrap gap-2 items-end">
                            ...
                            <span class="text-slate-500">00/100</span>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-3 mb-3">
