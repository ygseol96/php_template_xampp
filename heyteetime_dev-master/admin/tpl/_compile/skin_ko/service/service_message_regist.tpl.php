<?php /* Template_ 2.2.8 2024/06/10 09:32:50 C:\Users\devco\Documents\heyteetime_dev\admin\_global\skin_ko\service\service_message_regist.tpl 000042861 */ ?>
...
<div class="intro-y flex flex-wrap items-center justify-between ">
    <div>
        ...
        <div class="flex items-center mt-2">
            <h2 class="text-xl font-bold mr-auto">메세지 등록</h2>
        </div>
    </div>
    <div class="flex items-center gap-2 ml-auto">
        <button class="btn btn-primary"><i data-lucide="plus" class="w-4 h-4 mr-1"></i>메세지등록</button>
...
<div class="intro-y box p-5 mt-4">
    <div class="flex flex-col md:flex-row gap-3 mb-3">
        <div class="w-full md:w-40 pt-2 font-semibold">메세지명</div>
        <div class="flex-1">
            <input type="text" class="form-control" value="">
        </div>
    </div>
    <div class="flex flex-col md:flex-row gap-3 mb-3">
        <div class="w-full md:w-40 pt-2 font-semibold">메일구분</div>
        <div class="flex flex-wrap items-center gap-6">
            <div class="form-check">
                <input id="mail_classification_1_1" class="form-check-input" type="radio" name="mail_classification" checked>
                <label class="form-check-label" for="mail_classification_1_1">기획전</label>
            </div>
            <div class="form-check">
                <input id="mail_classification_1_2" class="form-check-input" type="radio" name="mail_classification">
                <label class="form-check-label" for="mail_classification_1_2">상품</label>
            </div>
            <div class="form-check">
                <input id="mail_classification_1_3" class="form-check-input" type="radio" name="mail_classification">
                <label class="form-check-label" for="mail_classification_1_3">이벤트</label>
            </div>
            <div class="form-check">
                <input id="mail_classification_1_4" class="form-check-input" type="radio" name="mail_classification">
                <label class="form-check-label" for="mail_classification_1_4">공지/알림</label>
            </div>
            <div class="form-check">
                <input id="mail_classification_1_5" class="form-check-input" type="radio" name="mail_classification">
                <label class="form-check-label" for="mail_classification_1_5">기타</label>
            </div>
        </div>
    </div>
    <div class="flex flex-col md:flex-row gap-3 mb-3">
        <div class="w-full md:w-40 pt-2 font-semibold">발송대상</div>
        <div class="flex-1 flex flex-wrap items-center gap-6">
            <div class="form-check">
                <input id="mail_lang_1_1" class="form-check-input" type="checkbox" name="coupon_1">
        ...
        <div class="flex-1 flex flex-wrap items-center gap-5">
            ...
            <div class="tab-content w-full border-b-2 border-primary">
                ...
                <div id="bylanguage-tab-1" class="tab-pane leading-relaxed active" role="tabpanel" aria-labelledby="bylanguage-1-tab">
                    ...
                    <div class="flex flex-col md:flex-row gap-3 mb-3">
                        <div class="w-full md:w-20 pt-2 font-semibold">발송형태</div>
                        <div class="flex-1 flex flex-wrap items-center gap-2">
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="message_shipping_type_3_1" name="message_shipping_type3">
                                <label for="message_shipping_type_3_1" class="block w-full px-2 py-1">SMS</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="message_shipping_type_3_2" name="message_shipping_type3">
                                <label for="message_shipping_type_3_2" class="block w-full px-2 py-1">LMS</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="message_shipping_type_3_3" name="message_shipping_type3">
                                <label for="message_shipping_type_3_3" class="block w-full px-2 py-1">MMS</label>
                            </div>
                        </div>
                    </div>

                    <!-- SMS : 내용 80byte, 링크&이미지 삽입 불가 -->
                    <!-- SMS : LMS : 내용+링크 1000byte -->
                    <!-- MMS : 내용+링크 1000byte + 이미지 1개 (1mb이하) png, jpg, gif로 1mb 이하 1개 이미지 -->

                    <div class="flex flex-col md:flex-row gap-3 mb-3">
                        <div class="w-full md:w-20 pt-2 font-semibold">내용</div>
                        <div class="flex-1 flex flex-wrap gap-2 items-end">
                            <input type="text" class="form-control w-full md:w-11/12" value="">
                            <span class="text-slate-500">0/80byte</span>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-3 mb-3">
                        <div class="w-full md:w-20 pt-2 font-semibold">링크</div>
                        <div class="flex-1">
                            <input type="text" class="form-control" value="" disabled>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-3 mb-3">
                        <div class="w-full md:w-20 pt-2 font-semibold">이미지</div>
