<?php /* Template_ 2.2.8 2024/06/14 13:11:40 C:\Users\devco\Documents\heyteetime_dev\admin\_global\skin_ko\service\service_terms_regist.tpl 000019470 */ ?>
...
<?php if(is_array($TPL_R1=$TPL_VAR["data"]['KindList'])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
		        <option value="<?php echo $TPL_V1["agree_kind_key_idx"]?>" data-name="<?php echo $TPL_V1["kind_name"]?>"><?php echo $TPL_V1["kind_name"]?></option>
<?php }}?>
		    </select>
		    <!--
