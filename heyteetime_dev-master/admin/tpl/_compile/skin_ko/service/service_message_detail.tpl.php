<?php /* Template_ 2.2.8 2024/06/05 15:25:47 C:\xampp\heytee_dev\admin\_global\skin_ko\service\service_message_detail.tpl 000016467 */ ?>
        ...
        <div class="flex items-center gap-2">
            <div class="flex-1 flex flex-wrap items-center py-1.5 px-3">
                <div class="flex-1 flex flex-wrap items-start gap-2">
                    <div>
                        <img src="/_global/skin_ko/service/dist/images/sample_img.jpg" class="w-full h-full md:w-[200px] md:h-[200px] object-cover" alt="">
                    </div>
                    <div class="w-4/5">
