<?php /* Template_ 2.2.8 2024/06/18 10:40:22 C:\Users\devco\Documents\heyteetime_dev\admin\_global\skin_ko\service\service_faq_mng.tpl 000015281 */ ?>
...
<?php if(is_array($TPL_R1=$TPL_VAR["data"]['KindList'])&&!empty($TPL_R1)){$TPL_I1=-1;foreach($TPL_R1 as $TPL_V1){$TPL_I1++;?>
                        <li class="flex items-center mt-0.5">
                            <input type="radio" class="form-check-input" id="faq_category_1_<?php echo $TPL_I1?>" value="<?php echo $TPL_V1["bbs_faq_option_key_idx"]?>" name="faq_category" onchange="gubun('<?php echo $TPL_V1["name"]?>','kind_gubun')">
                            <label for="faq_category_1_<?php echo $TPL_I1?>" class="block w-full px-2 py-1" data-name="<?php echo $TPL_V1["name"]?>"><?php echo $TPL_V1["name"]?></label>
                        </li>
<?php }}?>
                </ul>
            </div>
...
<?php if(is_array($TPL_R1=$TPL_VAR["data"]['data']['lang_kind'])&&!empty($TPL_R1)){$TPL_I1=-1;foreach($TPL_R1 as $TPL_V1){$TPL_I1++;?>
                         <li class="flex items-center mt-0.5">
                            <input type="radio" class="form-check-input" id="faq_language_1_<?php echo $TPL_I1?>" name="faq_language" value="<?php echo $TPL_V1["idx"]?>" onchange="gubun('<?php echo $TPL_V1["display_name"]?>(<?php echo $TPL_V1["code"]?>)','lang_gubun')">
                            <label for="faq_language_1_<?php echo $TPL_I1?>" class="block w-full px-2 py-1"><?php echo $TPL_V1["display_name"]?>(<?php echo $TPL_V1["code"]?>)</label>
                        </li>
<?php }}?>
