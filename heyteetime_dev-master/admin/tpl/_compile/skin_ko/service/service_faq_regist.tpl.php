<?php /* Template_ 2.2.8 2024/06/19 17:42:13 C:\Users\devco\Documents\heyteetime_dev\admin\_global\skin_ko\service\service_faq_regist.tpl 000010271 */ ?>
                    ...
                    <div class="flex flex-col md:flex-row gap-3 mb-3">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="editor w-full">
                                 <textarea name="content-<?php echo $TPL_I1?>" id="editor" class="w-full"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-3 mb-3">
