<?php /* Template_ 2.2.8 2024/06/11 15:17:35 C:\xampp\htdocs\heyteetime_dev\admin\_global\skin_ko\display\exhibition_pop_regist.tpl 000031714 */ ?>
...
<div class="intro-y flex flex-wrap items-center justify-between ">
    <div>
        ...
        <div class="flex items-center mt-2">
            <h2 class="text-xl font-bold mr-auto">팝업 등록</h2>
        </div>
    </div>
