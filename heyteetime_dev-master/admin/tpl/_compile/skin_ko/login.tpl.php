<?php /* Template_ 2.2.8 2024/06/19 15:21:22 C:\xampp\heyteetime_dev\admin\_global\skin_ko\login.tpl 000005170 */ ?>
<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="utf-8">
    ...
    <script src="/_global/<?php echo $_SESSION['adm_skin']?>/dist/js/custom.js"></script>
</head>    <body class="!p-0">
...
<script src="/_global/<?php echo $_SESSION['adm_skin']?>/js/custom/common.js?v=<?=time()?>"></script>
<!-- JS Assets-->
