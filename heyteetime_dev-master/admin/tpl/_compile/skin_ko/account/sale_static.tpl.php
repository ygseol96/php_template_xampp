<?php /* Template_ 2.2.8 2024/02/16 14:08:26 /home/agl/www/admin/_global/skin_ko/account/sale_static.tpl 000017701 */ 
			...
			<div style="position:relative;padding:10px; border:1px solid #ddd;"  >
				<ul >
					<li>
						...
						<span class="bar">|</span>
						<input type="button" class="SYButtonExcel03" title="엑셀다운로드" onclick="table_excel('sale_static')">
      ...
      <table class="statTable01">
        <thead>
          <tr>
            ...
            <th colspan=3>합계</th>
            <th colspan=3>TIGER GDS그룹상품</th>
            <th colspan=3>TIGER GDS FIT상품</th>
            <th colspan=3>TIGER PASS</th>
            <th colspan=3>TIGER GDS PLUS</th>
