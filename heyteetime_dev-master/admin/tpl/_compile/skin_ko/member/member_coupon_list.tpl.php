<?php /* Template_ 2.2.8 2024/06/19 15:21:22 C:\xampp\heyteetime_dev\admin\_global\skin_ko\member\member_coupon_list.tpl 000017792 */ ?>
<?php $this->print_("head",$TPL_SCP,1);?>

<?php $this->print_("header",$TPL_SCP,1);?>

<div class="intro-y flex items-center justify-between mt-8">
    <h2 class="text-xl font-bold mr-auto">쿠폰 목록</h2>
    <a href="./member_coupon_regist.php" class="btn btn-primary"><i data-lucide="plus" class="w-4 h-4"></i> 쿠폰추가</a>
</div>
    ...
    <div>
        ...
        <div class="flex flex-wrap items-center gap-1">
            ...
            <div class="relative w-full md:w-64">
                ...
                <input type="text" class="datepicker form-control pl-12" id="useDate">
            </div>
        </div>
    </div>
    <div>
            ...
            <div class="dropdown-menu w-full">
                <ul class="dropdown-content custom_select">
                    ...
                    <li class="flex items-center mt-0.5">
                        ...
                        <label for="member_check_4_2" class="block w-full px-2 py-1">HTT</label>
                    </li>
                    <li class="flex items-center mt-0.5">
                        <input type="checkbox" class="form-check-input" id="member_check_4_3" name="member_check_4">
                        <label for="member_check_4_3" class="block w-full px-2 py-1">Line dosi NFT</label>
                    </li>
                    <li class="flex items-center mt-0.5">
                        <input type="checkbox" class="form-check-input" id="member_check_4_4" name="member_check_4">
                        <label for="member_check_4_4" class="block w-full px-2 py-1">Google Booking</label>
                    </li>
                    <li class="flex items-center mt-0.5">
                        <input type="checkbox" class="form-check-input" id="member_check_4_5" name="member_check_4">
                        <label for="member_check_4_5" class="block w-full px-2 py-1">Google TTD</label>
                    </li>
                </ul>
            </div>
        </div>
...
<script>
    ...
    /* 날짜검색 */
    const useDate = new Litepicker({
        element: document.querySelector('#useDate'),
        singleMode: false,
        firstDay: 0,
        format: 'YYYY.MM.DD',
        lang: "ko-KR",
    ...
    var tabledata = [
        {number:1, kind:"정액할인1", division:"회원가입", coupon:"<span>신규회원<br/>할인쿠폰</span>", expiry:"<span>2024.01.01 ~<br/> 2024.03.31</span>", period:"<span>2024.01.01 ~<br/> 2024.03.31</span>", state:"정상", minimum:"500,000", limit:"50,000", amount:"지급(25/1000)", person:"홍길동", date:"24.01.01" },
        {number:2, kind:"정액할인", division:"회원가입", coupon:"<span>신규회원<br/>할인쿠폰</span>", expiry:"<span>2024.01.01 ~<br/> 2024.03.31</span>", period:"<span>2024.01.01 ~<br/> 2024.03.31</span>", state:"정상", minimum:"500,000", limit:"50,000", amount:"지급(25/1000)", person:"홍길동", date:"24.01.04" },
        {number:3, kind:"정액할인", division:"회원가입", coupon:"<span>신규회원<br/>할인쿠폰</span>", expiry:"<span>2024.01.01 ~<br/> 2024.03.31</span>", period:"<span>2024.01.01 ~<br/> 2024.03.31</span>", state:"만료", minimum:"500,000", limit:"50,000", amount:"지급(1/100)", person:"홍길동", date:"24.01.03" },
        {number:4, kind:"정액할인", division:"회원가입", coupon:"<span>신규회원<br/>할인쿠폰</span>", expiry:"<span>2024.01.01 ~<br/> 2024.03.31</span>", period:"<span>2024.01.01 ~<br/> 2024.03.31</span>", state:"정상", minimum:"500,000", limit:"50,000", amount:"미지급", person:"홍길동", date:"24.01.02" },
    ]
    */
    ...
    var table = new Tabulator("#tabulator", {
        ...
        columns:[ //define the table columns
            ...
            {title:"쿠폰종류", field:"kind", minWidth:110},
            {title:"쿠폰구분", field:"division", minWidth:110},
            {title:"쿠폰명", field:"coupon", minWidth:130, formatter:"html"},
            {title:"유효기간", field:"expiry", minWidth:150, formatter:"html"},
            {title:"지급기간", field:"period", minWidth:150, formatter:"html"},
            {title:"지급수량", field:"amount", minWidth:110},
            {title:"쿠폰상태", field:"state", minWidth:110},
            {title:"최소결제", field:"minimum", minWidth:110},
            {title:"한도", field:"limit", minWidth:100},
    ...
    function getParameterData() {
        ...
        //검색날짜
        let use_date = JSON.stringify($("#useDate").val().split(' ~ ').map(date => date.replace(/\./g, '-')));


        //지급사유
        let status = [];
        if(!$("#filter_kind input:checkbox:first").prop("checked")) {
            $("#filter_kind input:checkbox:not(:first):checked").each(function () {
