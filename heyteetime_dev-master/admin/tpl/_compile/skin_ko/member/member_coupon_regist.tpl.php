<?php /* Template_ 2.2.8 2024/06/19 15:21:22 C:\xampp\heyteetime_dev\admin\_global\skin_ko\member\member_coupon_regist.tpl 000046483 */ ?>
                ...
                <div class="flex flex-col md:flex-row gap-3 mb-2">
                    ...
                    <div class="flex-1 flex flex-wrap items-center gap-2">
                        <div class="overflow-hidden relative flex items-center gap-2 border border-slate-300 bg-white rounded-lg">
                            <img class="w-40" src="/_global/skin_ko/member/dist/images/sample_img.jpg" alt="">
