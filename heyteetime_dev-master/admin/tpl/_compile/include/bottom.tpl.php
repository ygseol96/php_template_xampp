<?php /* Template_ 2.2.8 2024/05/10 16:52:45 C:\xampp\heytee_dev\admin\_global\include\bottom.tpl 000037930 */ ?>
</div>
</div>

<!-- JS Assets-->
<script src="/_global/dist/js/app.js?v=<?=time()?>"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/jquery/latest/jquery.min.js"></script>
<!-- 테이블 js : tabulator -->
<script src="/_global/dist/js/tabulator.min.js?v=<?=time()?>"></script>
<!-- 차트 js 추가 -->
<script src="/_global/dist/js/chart.js?v=<?=time()?>"></script>
<script src="/_global/dist/js/datalabels.js?v=<?=time()?>"></script>
<script src="/_global/dist/js/swiper-bundle.min.js?v=<?=time()?>"></script>

<script src="/_global/js/jquery-2.2.4.min.js?v=<?=time()?>"></script>

    <!-- custom js 파일 호출 //-->
    <script src="/_global/dist/js/custom.js?v=<?=time()?>"></script>
...
<script src="/_global/js/custom/<?php echo $TPL_V1["name"]?>?v=<?=time()?>"></script>
<?php }}?>
<?php }?>
                    ...
                    <div id="exhibit_prod-tab-2" class="tab-pane leading-relaxed pt-3" role="tabpanel" aria-labelledby="exhibit_prod-2-tab">
                        <div class="flex flex-col gap-2">
                            ...
                            <button class="overflow-hidden relative rounded-xl border-4 border-primary">
                                <img src="/_global/dist/images/banner_sample.png" alt="">
                    ...
                    <div id="exhibit_prod-tab-4" class="tab-pane leading-relaxed" role="tabpanel" aria-labelledby="exhibit_prod-4-tab">
                        ...
                        <div class="z-10 relative flex flex-wrap items-center gap-2">
                            ...
                            <div class="overflow-hidden relative flex items-center gap-2 border-4 border-primary bg-white rounded-lg cursor-pointer">
                                <img class="w-40" src="/_global/include/dist/images/sample_img.jpg" alt="">
                                <!-- 이미지로만 사용시 아래 div 제거 -->
