<?php /* Template_ 2.2.8 2024/04/22 10:29:45 C:\xampp\heytee_dev\admin\_global\include\_mobile_menu.tpl 000014556 */ ?>
<?php echo $TPL_VAR["data"][ 0]?>

<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar justify-between">
        <a href="" class="flex">
            <img alt="logo" class="h-12" src="/_global/dist/images/heyteetime/logo_white.svg">
        </a>
    ...
    <div class="scrollable">
        ...
        <ul class="scrollable__content py-2">
            <li>
                <a href="/sys/dashboard.php" class="menu">
            ...
            <li>
                ...
                <ul class="<?=$side_depth=='member'?'menu__sub-open':'' ?>">
                    <li>
                        <a href="/sys/member/member_list.php" class="menu menu--active">
                            <div class="menu__title pl-4">회원 관리</div>
                        </a>
                    </li>
                    <li>
                        <a href="./member_coupon_payment_mng.php" class="menu menu--active">
                            <div class="menu__title pl-4">쿠폰지급 관리</div>
                        </a>
                    </li>
                    <li>
                        <a href="./member_coupon_mng.php" class="menu menu--active">
                            <div class="menu__title pl-4">쿠폰 관리</div>
                        </a>
                    </li>
                    <li>
                        <a href="./member_mileage_mng.php" class="menu menu--active">
                            <div class="menu__title pl-4">마일리지 관리</div>
                        </a>
                    </li>
                    <li>
                        <a href="./member_inquiry_mng.php" class="menu menu--active">
