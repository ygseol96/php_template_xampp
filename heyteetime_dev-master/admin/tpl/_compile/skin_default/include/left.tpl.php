<?php /* Template_ 2.2.8 2024/01/29 13:52:45 /home/agl/www/admin/_global/skin_default/include/left.tpl 000015737 */ ?>
<!--Sidebar left-->
            <div class="col-sm-3 col-xs-6 sidebar pl-0">
                <div class="inner-sidebar mr-3">
                    <!--Image Avatar-->
                    <div class="avatar text-center">
                        <img src="/_global/skin_default/assets/img/client-img4.png" alt="" class="rounded-circle" />
                        <p><strong><?php echo $_SESSION["admin_name"]?> <?php echo $_SESSION["admin_jikgub"]?></strong></p>
                        <span class="text-primary small"><strong><?php echo $_SESSION["admin_part_name"]?></strong></span>
                    </div>
                    <!--Image Avatar-->
                    ...
                    <div class="sidebar-menu-container">
                        <ul class="sidebar-menu mt-4 mb-4">
							<?php echo $TPL_VAR["slide_leftmenu"]?>
							...
							<li class="parent">
                                <a href="#" onclick="toggle_menu('test'); return false" class=""><i class="fa fa-calendar-o mr-3"> </i>
                                    <span class="none">대메뉴 <i class="fa fa-angle-down pull-right align-bottom"></i></span>
								</a>

								
								<ul class="children" id="test">
									
                                    <li class="child"><a href="#" class="ml-2"><i class="far fa-caret-square-down mr-2"></i> 중메뉴</a></li>
                                    <li class="child"><a href="email-inbox.html" class="ml-4"><i class="fa fa-angle-right mr-2"></i> 소메뉴</a></li>
								</ul>
