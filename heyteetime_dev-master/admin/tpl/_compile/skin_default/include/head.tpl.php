<?php /* Template_ 2.2.8 2024/01/29 13:44:20 /home/agl/www/admin/_global/skin_default/include/head.tpl 000012333 */ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
    ...
    <!--Animate CSS-->
    <link rel="stylesheet" href="/_global/skin_default/assets/css/animate.min.css">
    <!--Chartist CSS-->
    <link rel="stylesheet" href="/_global/skin_default/assets/css/chartist.min.css">
    <!--Map-->
    <link rel="stylesheet" href="/_global/skin_default/assets/css/jquery-jvectormap-2.0.2.css">
    <!--Bootstrap Calendar-->
    <link rel="stylesheet" href="/_global/skin_default/assets/js/calendar/bootstrap_calendar.css">
    <!--Nice select -->
    <link rel="stylesheet" href="/_global/skin_default/assets/css/nice-select.css">
        ...
        <div class="row header shadow-sm">
            ...
            <div class="col-sm-3 pl-0 text-center header-logo">
               <div class="bg-theme mr-3 pt-3 pb-2 mb-0">
                    <h3 class="logo"><a href="/" class="text-secondary logo"><i class="fa fa-rocket"></i> AGL<span class="small"> Admin</span></a></h3>
               </div>
            </div>
            <!--Logo-->
                    ...
                    <div class="col-sm-4 col-8 pl-0">
                        ...
                        <span class="menu-icon inbox">
                            ...
                            <div class="dropdown-menu dropdown-menu-left mt-10 animated zoomInDown" aria-labelledby="dropdownMenuLink3">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="media">
                                        <img class="align-self-center mr-3 rounded-circle" src="/_global/skin_default/assets/img/profile.jpg" width="50px" height="50px" alt="Generic placeholder image">
                                        <div class="media-body">
                    ...
                    <div class="col-sm-8 col-4 text-right flex-header-menu justify-content-end">
                        ...
                        <div class="mr-4">
                            <a class="" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="/_global/skin_default/assets/img/client-img4.png" alt="Adam" class="rounded-circle" width="40px" height="40px">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right mt-13" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="#"><i class="fa fa-user pr-2"></i> 마이페이지</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#"><i class="fa fa-th-list pr-2"></i> 작업리스트</a>
                                <div class="dropdown-divider"></div>
                                <!--<a class="dropdown-item" href="#"><i class="fa fa-book pr-2"></i> Projects</a>
                                <div class="dropdown-divider"></div>-->
                                <a class="dropdown-item" href="javascript:logout()"><i class="fa fa-power-off pr-2"></i> Logout</a>
                            </div>
                        </div>
                    </div>
                    <!--Search box and avatar-->
