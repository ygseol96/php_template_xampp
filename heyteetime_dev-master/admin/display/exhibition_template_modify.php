...
/** ---------------------------------------------------------------
@program : 관리자
@description : 템플릿수정(상세)
@fileinfo : /sys/display/exhibition_template_modify.php
@filedescription :
...
$data = [
    ...
    'js'=> [
        '0'  => [
            'name'  => 'display/template.js',
        ],
    ],
];

// 기본 인클루드 설정 header, footer 등을 아래설정한 템플릿 파일에 적용하겠다
include_tpl('display/exhibition_template_modify.tpl', $data);
