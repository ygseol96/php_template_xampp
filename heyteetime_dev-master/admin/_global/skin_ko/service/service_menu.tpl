                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu w-32">
                            <ul class="dropdown-content">
                                <li><a href="javascript:;" class="dropdown-item" onclick="modify_menu({.idx})">
                                ...
                                <li><a href="javascript:;" class="dropdown-item" onclick="delete_menu({.idx})">
