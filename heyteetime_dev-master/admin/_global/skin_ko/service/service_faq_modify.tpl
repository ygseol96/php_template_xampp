...
<input type="hidden" value="{=data['data']['main_idx']}" name="main_idx">
...
<div class="intro-y box p-5 mt-4 overflow-x-scroll">
        ...
        <div class="flex-1 flex flex-wrap items-center gap-6">
            {@ data['data']['lang_kind'] }
                <div class="form-check">
                    <input id="lang_1_{.index_}" data-index="{.index_}" value="{.idx}" class="form-check-input" type="checkbox" name="lang_1" {? data['data']['lang_kind'][.index_]['lang_chkYN'] == "Y" } checked {/}>
            ...
            <div class="tab-content w-full border-b-2 border-primary">
                ...
                <div id="lang-tab-{.index_}" class="tab-pane leading-relaxed" role="tabpanel" aria-labelledby="lang-{.index_}-tab">
                    ...
                    <div class="flex flex-col md:flex-row gap-3 mb-3">
                        ...
                        <div class="flex-1">
                            <input type="text" class="form-control" name="subject-{.index_}" value="{.subjects}">
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-3 mb-3">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="editor w-full">
                                 <textarea name="content-{.index_}" id="editor" class="w-full">{.contents}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-3 mb-3">
    ...
    <div class="flex flex-col md:flex-row gap-3 mb-4">
        ...
        <div class="flex-1 flex flex-wrap items-center gap-5">
            <div class="form-check">
                <input id="top_exposure2_1" class="form-check-input" type="radio" name="top_exposure" value="1" {? data['data'][0]['status'] == '1' } checked {/}>
                <label class="form-check-label" for="top_exposure2_1">노출</label>
            </div>
            <div class="form-check">
                <input id="top_exposure2_2" class="form-check-input" type="radio" name="top_exposure" value="0" {? data['data'][0]['status'] == '0' } checked {/}>
