...
<div class="intro-y box p-5 mt-3">
    ...
    <div class="flex flex-wrap items-start gap-2 p-2 border border-slate-200 rounded whitespace-nowrap">
        ...
        <div class="flex-1 py-1.5 px-3">
            ...
            <div>{ data['data']['PRODUCT_TYPE'] }</div>
        </div>
        <div class="flex-1 py-1.5 px-3">
            <div class="mb-0.5 text-slate-500">골프장</div>
            <div>{ data['data']['PRD_NAME'] }<br/>({ data['data']['FIELD_ID'] })</div>
        </div>
        <div class="flex-1 py-1.5 px-3">
            <div class="mb-0.5 text-slate-500">티타임</div>
            <div>{ data['data']['TEETIME'] }</div>
        </div>
        <div class="flex-1 py-1.5 px-3">
            <div class="mb-0.5 text-slate-500">공급가</div>
            <div>{=number_format( data['data']['ORIGIN_PRICE'], 2 )}</div>
        </div>
        <div class="flex-1 py-1.5 px-3">
            <div class="mb-0.5 text-slate-500">판매가</div>
            <div>{=number_format( data['data']['SALES_PRICE'], 2 ) }</div>
        </div>
        <div class="flex-1 py-1.5 px-3">
            <div class="mb-0.5 text-slate-500">사용여부</div>
            <div>{ data['data']['H_USE_YN'] }</div>
        </div>
        <div class="flex-1 py-1.5 px-3">
            <div class="mb-0.5 text-slate-500">수정</div>
            <div>{? data['data']['MOD_TEXT'] != '-' }{ data['data']['MOD_TEXT'] } ( { data['data']['UPTDATE'] } ){/}</div>
        </div>
    </div>
</div>
...
<div class="intro-y box p-5 mt-3">
    ...
    <div class="flex flex-col md:flex-row gap-3 mb-4">
        ...
        <div class="flex-1 flex flex-wrap gap-1">
            <input type="text" class="form-control w-24" value="{ data['data']['AREA_NAME'] }">
            <input type="text" class="form-control w-24" value="{ data['data']['NAT_NM'] }">
            <input type="text" class="form-control w-24" value="{ data['data']['STATE_NM'] }">
            <input type="text" class="form-control w-24" value="{ data['data']['CITY_NM'] }">
        </div>
    </div>
    <div class="flex flex-col md:flex-row gap-3 mb-4">
        <div class="w-full md:w-40 pt-2 font-semibold">상품</div>
        <div class="flex-1">
            <input type="text" class="form-control w-40" value="{ data['data']['PRD_NAME'] }">
        </div>
    </div>
    <div class="flex flex-col md:flex-row gap-3 mb-4">
        ...
        <div class="flex-1 flex flex-wrap gap-1">
            <div class="relative w-full md:w-64">
                ...
                <input type="text" class="datepicker form-control pl-12" value="{ data['data']['TEETIME'] }">
            </div>
        </div>
    </div>
    //-->
    ...
    <div class="flex flex-col md:flex-row gap-3 mb-4">
        ...
        <div class="flex-1 flex flex-wrap items-center gap-5">
            <div class="flex items-center gap-2">
                <span>Hole</span>
                <input type="text" class="form-control w-24" value="{ data['data']['HOLE_CNT'] }">
            </div>
            <div class="flex items-center gap-2">
                <span>Par</span>
                <input type="text" class="form-control w-24" value="{ data['data']['PAR_CNT'] }">
            </div>
            <div class="flex items-center gap-2">
                <span>전장</span>
                <input type="text" class="form-control w-24" value="{ data['data']['DISTANCE'] }">
            </div>
        </div>
    </div>
    <div class="flex flex-col md:flex-row gap-3 mb-4">
        ...
        <div class="flex-1 flex flex-wrap items-center gap-5">
            <div class="flex items-center gap-2">
                <span>위도</span>
                <input type="text" class="form-control w-40" value="{ data['data']['LAT'] }">
            </div>
            <div class="flex items-center gap-2">
                <span>경도</span>
                <input type="text" class="form-control w-40" value="{ data['data']['LNG'] }">
            </div>
        </div>
    </div>
    <div class="flex flex-col md:flex-row gap-3 mb-5">
        ...
        <div class="flex-1 flex flex-wrap items-center gap-5">
            <div class="flex items-center gap-2">
                <span>홈페이지</span>
                <input type="text" class="form-control w-full md:w-80" value="{ data['data']['WEBSITE'] }">
            </div>
            <div class="flex items-center gap-2">
                <span>이메일</span>
                <input type="text" class="form-control w-48" value="{ data['data']['RESERVE_EMAIL'] }">
            </div>
            <div class="flex items-center gap-2">
                <span>전화</span>
                <input type="text" class="form-control w-48" value="{ data['data']['PHONE'] }">
            </div>
        </div>
    </div>
    <div class="flex flex-col md:flex-row gap-3 mb-5">
        ...
        <div class="flex-1">
            <div class="flex flex-wrap items-center gap-6">
                ...
                <div class="form-check">
                    <input id="teetime_1_{.index_}" data-index="{.index_}" value="{.idx}" class="form-check-input" type="checkbox" name="teetime_1">
                    <label class="form-check-label" for="teetime_1_{.index_}">{.display_name}({.code})</label>
                </div>
                {/}
            </div>
    ...
    <div class="flex flex-col md:flex-row gap-3 mb-3">
        ...
        <div class="flex-1 flex flex-wrap items-center gap-5">
            <ul class="nav nav-boxed-tabs flex-wrap gap-0.5 border-b-2 border-primary" role="tablist">
                {@ data['data']['lang_kind'] }
                <li id="teetime-{.index_}-tab" class="nav-item" role="presentation">
                    <button class="nav-link py-2 bg-white" data-tw-toggle="pill" data-tw-target="#teetime-tab-{.index_}" type="button" role="tab" aria-controls="teetime-tab-{.index_}" aria-selected="true" disabled>{.display_name}({.code})</button>
                </li>
                {/}
            </ul>
            <div class="tab-content w-full border-b-2 border-primary">
                <!-- 한국어 -->
                {@ data['data']['lang_kind'] }
                <div id="teetime-tab-{.index_}" class="tab-pane leading-relaxed" role="tabpanel" aria-labelledby="teetime-{.index_}-tab">
                    <div class="flex flex-col md:flex-row gap-1 mb-2">
                        <div class="w-full md:w-28 pt-1 font-medium">골프장명*</div>
                        <div class="flex-1">
                            <input name="prod_name" type="text" class="form-control inp required" value="{ data['data']['PRD_NAME'] }">
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-1 mb-2">
                    ...
                    <div class="flex flex-col md:flex-row gap-1 mb-2">
                        ...
                        <div class="flex-1">
                            <input name="prod_addr" type="text" class="form-control inp required" value="{ data['data']['ADDR'] }">
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-1 mb-2">
                    ...
                    <div class="flex flex-col md:flex-row gap-1 mb-2">
                        ...
                        <div class="flex-1">
                            <input name="prod_distance" type="text" class="form-control inp required" value="{ data['data']['DISTANCE'] } { data['data']['DISTANCE_ME'] }">
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-1 mb-2">
                        <div class="w-full md:w-28 pt-1 font-medium">주의사항*</div>
                        <div class="flex-1">
                            <textarea name="prod_notandum" class="form-control block h-20 resize-none inp required">{ data['data']['RESERVE_MEMO'] }</textarea>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-1 mb-2">
                    ...
                    <div class="flex flex-col md:flex-row gap-1 mb-2">
                        ...
                        <div class="flex-1">
                            <textarea name="prod_essential" class="form-control block h-20 resize-none inp required">{ data['data']['PIN_MEMO'] }</textarea>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-1 mb-2">
                        <div class="w-full md:w-28 pt-1 font-medium">불포함사항*</div>
                        <div class="flex-1">
                            <textarea name="prod_not_essential" class="form-control block h-20 resize-none inp required">{ data['data']['POUT_MEMO'] }</textarea>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-1 mb-2">
    ...
    <input type="hidden" name="teetime_field_id" value="{data['data']['fieldId']}">
    <div class="flex flex-col md:flex-row gap-3 mb-5">
            ...
            <div class="overflow-x-auto">
                <table class="table table-sm">
                    ...
                    <tr>
                        ...
                        {@ data['data']['exchang_kind'] }
                        <th class="whitespace-nowrap">{.currency_code}</th>
                        {/}
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    {@ data['data']['ratio'] }
                        <tr class="ratio_area">
                            <input type="hidden" name="channel_code[]" value="{.channel}">
                            <td>공통</td>
                            {@ data['data']['exchang_kind'] }
                                <input type="hidden" name="currency[]" value="{..currency_code}">
                                <td>
                                    <div class="flex items-center gap-1">
                                        <select class="form-select w-20" name="{..currency_code}_type[]]">
                                            <option value="F" {? data['data']['ratio'][.index_][..currency_code]['gubun'] == 'F'} selected {/}>금액</option>
                                            <option value="R" {? data['data']['ratio'][.index_][..currency_code]['gubun'] == 'R'} selected {/}>비율</option>
                                        </select>
                                        <input type="text" value="{=number_format( data['data']['ratio'][.index_][..currency_code]['RATIO'], 2 ) }" name="{..currency_code}_price[]" class="form-control w-24">
                                    </div>
                                </td>
                            {/}
                        </tr>
            ...
            <div>
                ...
                <div class="flex items-center gap-1">
                    <select class="form-select w-20" name="point_type">
                        <option value="F" {? data['data']['MEMBER_RATIO_GUBUN'] == 'F' }selected{/}>금액</option>
                        <option value="R" {? data['data']['MEMBER_RATIO_GUBUN'] == 'R' }selected{/}>비율</option>
                    </select>
                    <input type="text" name="point" value="{=number_format( data['data']['MEMBER_RATIO'], 2 )}" class="form-control w-24">
                </div>
            </div>
            <!--
            <div>
    ...
    <div class="flex flex-col md:flex-row gap-3 mb-5">
        ...
        <div class="flex-1 flex flex-wrap items-center gap-6">
            <div class="form-check">
                <input id="teetime_2_1" class="form-check-input" value="Y" {? data['data']['H_USE_YN'] != 'N' || data['data']['H_USE_YN'] == 'Y' } checked {/} type="radio" name="teetime_2">
                <label class="form-check-label" for="teetime_2_1">사용</label>
            </div>
            <div class="form-check">
                <input id="teetime_2_2" class="form-check-input" value="N" {? data['data']['H_USE_YN'] == 'N' } checked {/} type="radio" name="teetime_2">
