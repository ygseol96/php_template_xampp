...
<form name="schForm" id="schForm" >
	...
	<input type="hidden" name="s_join" id="s_join" value="{_REQUEST.s_join}">
	...
	<div id="SYBoardBox" class="SYManagerTable" style="margin-top:20px">
		...
		<table class="SYManagerTable01">
			...
			<tbody>
				...
				<tr >						
					<td  class="ce">
						<input type='hidden' name='sort1[]' value='{.cj_seq}' />
					...
					<td  class="ce">{.use_yn_txt}</td>
					
					<td  class="ce">
						<input type="button" class="SYButtonType03" value="수정" onclick="jikgub_write('{.cj_seq}')" >
						
					</td>
					<td  class="ce">
						<input type="button" class="SYButtonDelete01" onclick="jk_del('{.cj_seq}')" >
