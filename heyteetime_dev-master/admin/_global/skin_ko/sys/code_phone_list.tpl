		...
		<table class="SYManagerTable01">
			...
			{:}
				...
				<tr >						
					...
					<td  class="ce">{.phone_code}</td>
					<td  class="ce">{.view_yn_txt}</td>
					<td  class="ce">
						<input type="button" class="SYButtonType03" value="수정" onclick="code_phone_write('{.np_seq}')" >
						
					</td>
					<td  class="ce">
						<input type="button" class="SYButtonDelete01" onclick="code_phone_del('{.np_seq}')" >
					</td>
					<td > </td>
				</tr>
				{/}
