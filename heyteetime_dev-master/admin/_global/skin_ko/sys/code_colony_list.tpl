		...
		<table class="SYManagerTable01">
			...
			{:}
				...
				<tr >						
					...
					<td  class="ce">{.col_name}</td>
					<td  class="le">{.nat_list}</td>

					
					<td  class="ce">{.view_yn_txt}</td>
					<td  class="ce">
						<input type="button" class="SYButtonType03" value="수정" onclick="code_colony_write('{.col_seq}')" >
						
					</td>
					<td  class="ce">
						<input type="button" class="SYButtonDelete01" onclick="code_colony_del('{.col_seq}')" >
					</td>
					<td > </td>
				</tr>
				{/}
