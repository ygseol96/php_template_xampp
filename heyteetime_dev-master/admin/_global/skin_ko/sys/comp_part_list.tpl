	...
	<div id="SYBoardBox" class="SYManagerTable" style="margin-top:20px">
		...
		<table class="SYManagerTable01">
			...
			<tbody>
				...
				<tr >						
					<td  class="ce">
						<input type='hidden' name='sort1[]' value='{.cp_seq}' />
					...
					<td  class="ce">
						<input type="button" class="SYButtonType03" value="수정" onclick="part_write('{.cp_seq}')" >
						
					</td>
					<td  class="ce">
						<input type="button" class="SYButtonDelete01" onclick="part_del('{.cp_seq}')" >
