		...
		<table class="SYManagerTable01">
			...
			{:}
				...
				<tr >						
					...
					<td  class="ce">{.nat_nm_kr}</td>
					<td  class="ce">{.nat_nm_en}</td>
					<td  class="ce">{.nat_nm_jp}</td>
					<td  class="ce">{.nat_nm_cn}</td>
					<td  class="ce">{.cd_name}</td>
					<td  class="ce">{.curr_cd}</td>
					<td  class="ce">{.curr_cd_nm}	</td>

					<td  class="ce">{.view_yn_txt}</td>
					<td  class="ce">
						<input type="button" class="SYButtonType03" value="수정" onclick="code_nation_write('{.nat_seq}')" >
						
					</td>
					<td  class="ce">
						<input type="button" class="SYButtonDelete01" onclick="code_nation_del('{.nat_seq}')" >
					</td>
					<td > </td>
				</tr>
				{/}
