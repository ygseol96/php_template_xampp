	...
	<form name="iform" id="iform">
		...
		<div id="SYRightArea" >
			<div id="SYContentTitle">
				<ul>
				   <li id="SYMenuTitle" class="Title"> 국가번호코드 상세 {? editmode == "code_phone_update" } - {data.nat_cd}{/}</li>
			...
			<table class="SYWirteTable" style="margin-top:10px">
				...
				<tr>
					...
					<td class="Content"  >
						...
						{:}
							{data.nat_name} ({data.nat_cd})
						{/}
						
					</td>
					<td class="Title" >국가번호 *</td> 
					<td class="Content"  >
						<input type="text" name="phone_code" id="phone_code" class="SYInputStyle02 upper"  value="{data.phone_code}"  autocomplete="off" maxlength=10 style="width:100px">
						<p class="Tip01"></p>
