		...
		<table class="SYManagerTable01">
			...
			{:}
				...
				<tr >						
					...
					<td  class="ce">{.airport_nm_kr}</td>
					<td  class="ce">{.airport_nm_en}</td>
					<td  class="ce">{.airport_nm_jp}</td>
					<td  class="ce">{.airport_nm_cn}</td>
					<td  class="ce">{.nat_cd}</td>
					<td  class="ce">{.nat_name}</td>
					<td  class="ce">{.city_code}</td>
					<td  class="ce">{.city_name}</td>
					<td  class="ce">{=dbUnEscape(.airport_nm_keyword)}</td>
					<td  class="ce">{.view_yn_txt}</td>
					<td  class="ce">
						<input type="button" class="SYButtonType03" value="수정" onclick="code_airport_write('{.airp_seq}')" >
						
					</td>
					<td  class="ce">
						<input type="button" class="SYButtonDelete01" onclick="code_airport_del('{.airp_seq}')" >
					</td>
					<td > </td>
				</tr>
				{/}
