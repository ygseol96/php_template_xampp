...
<div class="intro-y box p-5 flex flex-wrap items-end gap-2 mt-3">
            ...
            <div class="dropdown-menu w-full">
                <ul class="dropdown-content custom_select multi">
                    <li class="flex items-center">
                        <input type="checkbox" class="form-check-input" class="form-check-input" id="member_check_1_1" value="unfilled">
                        <label for="member_check_1_1" class="block w-full px-2 py-1">미입력</label>
                    </li>
                    <li class="flex items-center mt-0.5">
                        <input type="checkbox" class="form-check-input" id="member_check_1_2" value='filling'>
                        <label for="member_check_1_2" class="block w-full px-2 py-1">입력중</label>
                    </li>
                    <li class="flex items-center mt-0.5">
                        <input type="checkbox" class="form-check-input" id="member_check_1_3" value="filled">
    ...
    <div>
        ...
        <div class="flex flex-wrap items-center gap-1 flex-1">
            <select name="" id="continents" class="form-select md:w-auto">
                ...
                {@data['continents']}
                    <option value="{.cd}">{.cd_name}</option>
                {/}
            </select>
            <select name="" id="nations" class="form-select w-40">
                <option value="" disabled hidden selected>국가</option>
            </select>
            {*<select name="" id="cities" class="form-select md:w-auto">
                <option value="" disabled hidden selected>주/도</option>
            </select>*}
    ...
    {*<div>
        ...
        <div class="dropdown">
            <button class="dropdown-toggle form-select w-28 text-left" aria-expanded="false" data-tw-toggle="dropdown">전체</button>
            <div class="dropdown-menu w-full product_option">
                <ul class="dropdown-content custom_select">
                    {@ INC['option']}
                         <li class="flex items-center {? .index_ > 0} mt-0.5 {/}">
                            <input type="checkbox" class="form-check-input" id="member_check_11_{.key_}" name="member_check_11" value="{.key_}">
                            <label for="member_check_11_1" class="block w-full px-2 py-1">{INC['option'][.key_]}</label>
                        </li>
                    {/}
                </ul>
            </div>
...
{*            <button class="btn btn-dark w-30">결제요청</button>*}
...
{*            {title:"에약상태<br/>예약정보", field:"state", minWidth:130, headerSort:false, formatter:"html"},*}
