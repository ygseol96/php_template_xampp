...
<div class="top-bar">
    ...
    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">{data['nav'][0]}</a></li>
            <li class="breadcrumb-item <?=$depth_3 ?'':'active' ?>" aria-current="page">{data['nav'][1]}</li>
            <li class="breadcrumb-item <?=$depth_3 ?'active':'hidden' ?>" aria-current="page">{data['nave'][2]}</li>
        </ol>
    </nav>
    <!-- END: Breadcrumb -->
    ...
    <div class="intro-x dropdown w-8 h-8">
        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-tw-toggle="dropdown">
            <img alt="Midone - HTML Admin Template" src="/_global/{_SESSION['adm_skin']}/dist/images/sample_img.jpg">
        </div>
