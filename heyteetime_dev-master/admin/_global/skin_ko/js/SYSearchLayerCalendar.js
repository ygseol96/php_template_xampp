function SYLayerCalendarView(sy_type,sy_value) {
	toDate = new Date(); 	
	sy_dates = sy_value;
	if(document.form1[sy_type+"_year"].value!="") {
		sy_dates = document.form1[sy_type+"_year"].value;
		if(document.form1[sy_type+"_month"].value != "") sy_dates += "-"+document.form1[sy_type+"_month"].value;
		else sy_dates += "-"+SYNumCut(toDate.getMonth()+1,2);
		if(document.form1[sy_type+"_day"].value != "") sy_dates += "-"+document.form1[sy_type+"_day"].value;
		else sy_dates += "-"+SYNumCut(toDate.getDate(),2);
	}
	SYLayerCalendarViewContent(sy_type,sy_dates)
}

function SYLayerCalendarView2(sy_type,sy_value) {
	toDate = new Date(); 	
	sy_dates = sy_value;
	if(document.form1[sy_type+"_year"].value!="") {
		sy_dates = document.form1[sy_type+"_year"].value;
	...
	SYLayerCalendarViewContent2(sy_type,sy_dates)
}
...
function SYLayerCalendarViewContent(sy_type,sy_value) {
	...
	SYLayerCalendarTable.style.top="-70px";
	if(sy_type=="sy_search_start") SYLayerCalendarTable.style.left = "202px";
	...
	document.getElementById(sy_type+"Header").innerHTML = "<input type=\"button\" class=\"SYLayerCalendarPrev\" onclick=\"SYLayerCalendarViewContent('"+sy_type+"','"+(sy_year-1)+sy_month+sy_day+"');\" value=\"\"><span class=\"MouseHand\" onclick=\"SYLayCalendarDateInsert('"+sy_type+"','"+sy_year+"--');\">"+sy_year+"</span><input type=\"button\" class=\"SYLayerCalendarNext\" onclick=\"SYLayerCalendarViewContent('"+sy_type+"','"+(sy_year*1+1)+sy_month+sy_day+"');\" value=\"\"> <input type=\"button\" class=\"SYLayerCalendarPrev\" onclick=\"SYLayerCalendarViewContent('"+sy_type+"','"+SYPrevMonth+"');\" value=\"\"><span class=\"MouseHand\" onclick=\"SYLayCalendarDateInsert('"+sy_type+"','"+sy_year+"-"+sy_month+"-');\">"+sy_month+"</span><input type=\"button\" class=\"SYLayerCalendarNext\" onclick=\"SYLayerCalendarViewContent('"+sy_type+"','"+SYNextMonth+"');\" value=\"\">";
			...
			if(j>=StartAday || i > 0) {
				if(SYDay<=SYLastDate) {
					...
					Tr1Td.onclick = function() {
						SYLayCalendarDateInsert(sy_type,this.id);
					}
				}
				SYDay++;
			}
...
function SYLayerCalendarViewContent2(sy_type,sy_value) {
	document.getElementById(sy_type).innerHTML="";
	var SYLayerCalendarTable = document.createElement("table");
	document.getElementById(sy_type).appendChild(SYLayerCalendarTable);
	SYLayerCalendarTable.className="SYLayerCalendar";
	SYLayerCalendarTable.style.top="120px";
	//SYLayerCalendarTable.style.top=sy_type.offsetTop+"px";
	//if(sy_type=="sy_search_start") SYLayerCalendarTable.style.left = (sy_type.offsetLeft + 150) +"px";
	...
	SYLayerCalendarH3.setAttribute("id",sy_type+"Header");
	Tr1Td1.appendChild(SYLayerCalendarH3);
	document.getElementById(sy_type+"Header").innerHTML = "<input type=\"button\" class=\"SYLayerCalendarPrev\" onclick=\"SYLayerCalendarViewContent2('"+sy_type+"','"+(sy_year-1)+sy_month+sy_day+"');\" value=\"\"><span class=\"MouseHand\" onclick=\"SYLayCalendarDateInsert('"+sy_type+"','"+sy_year+"--');\">"+sy_year+"</span><input type=\"button\" class=\"SYLayerCalendarNext\" onclick=\"SYLayerCalendarViewContent2('"+sy_type+"','"+(sy_year*1+1)+sy_month+sy_day+"');\" value=\"\"> <input type=\"button\" class=\"SYLayerCalendarPrev\" onclick=\"SYLayerCalendarViewContent2('"+sy_type+"','"+SYPrevMonth+"');\" value=\"\"><span class=\"MouseHand\" onclick=\"SYLayCalendarDateInsert('"+sy_type+"','"+sy_year+"-"+sy_month+"-');\">"+sy_month+"</span><input type=\"button\" class=\"SYLayerCalendarNext\" onclick=\"SYLayerCalendarViewContent2('"+sy_type+"','"+SYNextMonth+"');\" value=\"\">";
...
function SYLayCalendarDateInsert(sy_type,sy_value) {
