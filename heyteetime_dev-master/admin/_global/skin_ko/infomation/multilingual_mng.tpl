                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu w-32">
                            <ul class="dropdown-content">
                                <li> <a href="javascript:;" class="dropdown-item" onclick="modifyCategory({.idx});"> <i data-lucide="pencil" class="w-4 h-4 mr-2"></i> 수정 </a> </li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {@ data['lKind'] }
                <div class="flex items-start gap-2 mb-2">
                    <div class="shrink-0 w-20 py-2 font-semibold">{.display_name}</div>
                    <div class="flex-1">
                        <input type="text" name="{.code}_name" class="form-control required" placeholder="{.display_name}({.code})를 입력해주세요">
                    </div>
                </div>
                {/}
                <div class="flex gap-2 justify-center mt-5">
