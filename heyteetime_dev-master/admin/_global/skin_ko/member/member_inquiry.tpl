                ...
                <ul class="dropdown-content custom_select multi">
                    ...
                    <!--{@INC['inquiry_gubun']}-->
                        <li class="flex items-center mt-0.5">
                            <input type="checkbox" class="form-check-input" id="member_check_1_{.index_ + 2}" value="{.index_}" checked>
                            <label for="member_check_1_{.index_ + 2}" class="block w-full px-2 py-1">{.value_}</label>
                        </li>
                    <!--{/}-->
                </ul>
            </div>
        ...
        <div class="dropdown" id="filter_status">
            ...
            <div class="dropdown-menu w-full">
                <ul class="dropdown-content custom_select">
                    ...
                    <!--{@INC['inquiry_status']}-->
                        <li class="flex items-center mt-0.5">
                            <input type="radio" class="form-check-input" id="member_check_2_{.index_ + 2}" name="member_check_2" value="{.key_}">
                            <label for="member_check_2_{.index_ + 2 }" class="block w-full px-2 py-1">{ .value_ }</label>
                        </li>
                    <!--{/}-->
                </ul>
            </div>
...
<script>
    ...
    function downloadExcel() {
         let fileName = '1:1문의목록_' + getFormattedDate_yymmdd();

        let data = {
            type: 'getExcelForInquiryList',
            fileName: fileName,
            ...getParameterData()
        };
