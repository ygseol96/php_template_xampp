...
<input type="hidden" id="social_user_idx" value="{data['member']['social_user_idx']}">
<input type="hidden" id="member_id" value="{data['member']['idx']}">
<div class="intro-y mt-6">
    ...
    <div class="intro-y box p-5 mt-2 flex flex-wrap items-center overflow-hidden whitespace-nowrap">
        <div class="flex-1 px-5 py-2 border-r border-slate-200/60">
            ...
            <div class="truncate text-base" id="signup-method">{data['member']['social_name']}</div>
        </div>
        <div class="flex-1 px-5 py-2 border-r border-slate-200/60">
            <div class="text-slate-500">가입일시</div>
            <div class="truncate text-base" id="signup-date">{data['member']['reg_date']}</div>
        </div>
        <div class="flex-1 px-5 py-2 border-r border-slate-200/60">
            <div class="text-slate-500">회원상태</div>
            <div class="truncate text-base" id="member-status">{data['member']['status']}</div>
        </div>
        <div class="flex-1 px-5 py-2">
            <div class="text-slate-500">탈퇴일시</div>
            <div class="truncate text-base" id="withdrawal-date">{data['member']['out_date']}</div>
        </div>
    </div>
</div>
...
<div class="intro-y mt-6">
    ...
    <div class="intro-y box p-5 mt-2 flex flex-wrap items-center overflow-hidden whitespace-nowrap">
        <div class="flex-1 px-5 py-2 border-r border-slate-200/60">
            ...
            <div id="account" class="truncate text-base">{data['member']['account']}</div>
        </div>
        {*<div class="flex-1 px-5 py-2 border-r border-slate-200/60">
        ...
        <div class="flex-1 px-5 py-2 border-r border-slate-200/60">
            ...
            <div id="name" class="truncate text-base">{data['member']['first_name']} {data['member']['last_name']}</div>
        </div>
        <div class="flex-1 px-5 py-2 border-r border-slate-200/60">
            <div class="text-slate-500">연락처</div>
            <div id="contact" class="truncate text-base">{data['member']['country_code']} {data['member']['phone_number']}</div>
        </div>
        <div class="flex-1 px-5 py-2 border-r border-slate-200/60">
            <div class="text-slate-500">국적</div>
            <div id="nationality" class="truncate text-base">{? data['member']['nat_nm_kr'] != ''} {data['member']['nat_nm_kr']} {:} - {/} </div>
        </div>
        <div class="flex-1 px-5 py-2">
            <div class="text-slate-500">성별</div>
            <div id="gender" class="truncate text-base">{data['member']['sex']}</div>
        </div>
    </div>
</div>
            ...
            <div class="box mb-4 p-4 flex flex-wrap items-start justify-between gap-2">
                ...
                <div class="py-1.5 px-2">
                    ...
                    <div><button class="relative w-full overflow-hidden rounded" data-tw-toggle="modal" data-tw-target="#img_detail-modal">
                            ...
                            <img class="w-full" src="./dist/images/heyteetime/sample_img.png" alt="">
                        </button></div>
                </div>
                <div class="py-1.5 px-2">
        ...
        <div id="member-tab-5" class="tab-pane leading-relaxed p-4 box" role="tabpanel" aria-labelledby="member-5-tab">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                <div class="grid grid-cols-3 gap-3 cursor-pointer" onclick="location.href='./member_detail.php'">
                    <div class="overflow-hidden rounded"><img class="w-full" src="./dist/images/sample_img.jpg" alt=""></div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header flex-wrap">
                <h2 class="font-medium text-base mr-auto flex flex-wrap items-center gap-1"><img class="sm:h-10 h-8 mr-2" src="./dist/images/heyteetime/heyteetime_logo.png" alt="">과 함께한 골프여행의 추억</h2>
            ...
            <div class="modal-body p-3 lg:p-5 text-center">
                <div class="flex flex-col sm:flex-row items-start lg:items-center gap-4">
                    <div class="overflow-hidden w-full sm:w-40 rounded"><img class="w-full" src="./dist/images/sample_img.jpg" alt=""></div>
                    <div class="grid grid-cols-1 lg:grid-cols-2 flex-1">
                        ...
                        <div>
                            ...
                            <div class="flex items-center mt-2">
                                ...
                                <div>
                                    <button><img class="w-8" src="./dist/images/insta.png" alt=""></button>
                                    <button><img class="w-8" src="./dist/images/youtube.png" alt=""></button>
                                    <button><img class="w-8" src="./dist/images/face.png" alt=""></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-7">
                    ...
                    <div class="grid grid-cols-5 md:grid-cols-7 gap-2 mt-4">
                        ...
                        <div class="overflow-hidden rounded"><img class="w-full" src="./dist/images/heyteetime/sample_img.png" alt=""></div>
                        <div class="overflow-hidden rounded"><img class="w-full" src="./dist/images/heyteetime/sample_img.png" alt=""></div>
                        <div class="overflow-hidden rounded"><img class="w-full" src="./dist/images/heyteetime/sample_img.png" alt=""></div>
                        <div class="overflow-hidden rounded"><img class="w-full" src="./dist/images/heyteetime/sample_img.png" alt=""></div>
                ...
                <div class="flex items-start gap-2 mb-2">
                    ...
                    <div class="flex-1 flex items-center gap-2">
                        <select class="form-select w-36" id="country_code">
                            {? !data['member']['country_code']}
                                <option value="" selected >미선택</option>
                            {/}
                            {@ data['phoneCodes']}
                                <option value="{.phone_code}" {? .phone_code == data['member']['country_code']} selected {/}>{.phone_code} ({.nat_nm_kr})</option>
                            {/}
                        </select>
                        <input type="text" class="form-control" id="phone_number" value={? data['member']['phone_number'] !== '-'} {data['member']['phone_number']} {/}>
                    </div>
                </div>
                <div class="flex items-start gap-2 mb-2">
                    ...
                    <div class="flex-1">
                        <select class="form-select" id="nationality_type">
                            {? !data['member']['nationality_type']}
                                <option value="" selected >미선택</option>
                            {/}
                            {@ data['nationalityOptions']}
                                <option value="{.nat_seq}" {? .nat_seq == data['member']['nationality_type']} selected {/}>{.nat_nm_kr}</option>
                            {/}
                        </select>
                    </div>
                </div>
                <div class="flex items-start gap-2 mb-2">
                    ...
                    <div class="flex-1">
                        <select class="form-select" id="sex">
                            <option value="M" {? data['member']['sex']=='남'} selected {/}>남성</option>
                            <option value="F" {? data['member']['sex']=='여'} selected {/}>여성</option>
                            {? data['member']['sex'] == '미입력' }
                                <option value=""{? data['member']['sex']=='미입력'} selected {/}>미입력</option>
                            {/}
                        </select>
                    </div>
                </div>
